...
/*
  ...
  Or:
    BOOKS_ROOT=path/to/audio-text/books node scripts/qa/validate-book-content-cleanup.mjs
*/
import fs from 'node:fs';
import path from 'node:path';

const root = process.env.BOOKS_ROOT || path.join(process.cwd(), 'audio-text', 'books');
const problems = [];
function walk(dir) {
...
// exact duplicate page content across different books
