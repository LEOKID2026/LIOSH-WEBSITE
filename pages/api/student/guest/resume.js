...
import { resumeGuestStudent } from "../../../../lib/guest/guest-student.server.js";
...
export default async function handler(req, res) {
  ...
  if (!resumeToken) {
    return res.status(400).json({ ok: false, error: "missing_resume_token", code: "missing_resume_token" });
  }
  ...
  try {
    ...
    return res.status(200).json({
      ...
      leoNumber: result.student?.leo_number ?? null,
