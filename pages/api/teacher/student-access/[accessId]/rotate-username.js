...
import { rotateTeacherGuardianUsername } from "../../../../../lib/teacher-server/teacher-student-access.server.js";
import {
  ...
  try {
    if (isProductionRuntime()) {
      ...
      const rl = consumeRateLimit({
        namespace: "teacher_student_access_rotate_username",
    ...
    const rotated = await rotateTeacherGuardianUsername({
    ...
    safeApiLog("teacher_student_access_rotate_username_error", {});
