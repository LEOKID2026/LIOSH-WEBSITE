...
import { rotateTeacherStudentLoginPin } from "../../../../../lib/teacher-server/teacher-student-login-access.server.js";
import {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await rotateTeacherStudentLoginPin({
    ...
    safeApiLog("teacher_student_login_access_rotate_pin_error", {});
