...
import { revokeTeacherStudentLoginAccess } from "../../../../../lib/teacher-server/teacher-student-login-access.server.js";
import {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await revokeTeacherStudentLoginAccess({
    ...
    safeApiLog("teacher_student_login_access_revoke_error", {});
