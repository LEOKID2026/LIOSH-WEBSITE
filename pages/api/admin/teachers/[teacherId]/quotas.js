...
export default async function handler(req, res) {
  ...
  try {
    ...
    const parsed = parseAdminQuotaPatchBody(req.body);
    if (!parsed.ok) {
    ...
    safeApiLog("admin_teacher_quotas_error", { route: "admin/teachers/[teacherId]/quotas" });
