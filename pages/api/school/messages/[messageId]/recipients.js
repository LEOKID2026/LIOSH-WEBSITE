...
import { listSchoolMessageRecipients } from "../../../../../lib/school-server/school-messaging.server.js";
import {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await listSchoolMessageRecipients(
      ctx.serviceRole,
      ctx.schoolId,
      messageId,
    ...
    safeApiLog("school_message_recipients_error", { route: "school/messages/[messageId]/recipients" });
