...
import { reactivateSchoolStaffAccess } from "../../../../../lib/school-server/school-staff-management.server.js";
import {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await reactivateSchoolStaffAccess(ctx.serviceRole, {
    ...
    return res.status(200).json({ data: { reactivated: true } });
  } catch (_e) {
    safeApiLog("school_operator_reactivate_error", {});
