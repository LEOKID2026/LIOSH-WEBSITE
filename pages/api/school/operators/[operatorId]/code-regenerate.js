...
import { regenerateSchoolStaffCode } from "../../../../../lib/school-server/school-staff-management.server.js";
import {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await regenerateSchoolStaffCode(ctx.serviceRole, {
    ...
    safeApiLog("school_operator_code_regenerate_error", {});
