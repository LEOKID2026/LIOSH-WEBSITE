...
export default function Curriculum() {
  ...
  const subjectDescriptions = {
    math:
      "מותאם לפי כיתה, נושא ורמת קושי — כפי שמוצגים בדף החשבון. הניסוח נבדק מול מבנה תוכנית הלימודים וקבצי ה-PDF הרשמיים של הכיתות (במסגרת בקרות האתר). חתימת בעלים או בדיקה ידנית סופית עדיין לא הופעלה — אין טענה לאישור רשמי מלא של התוכנית.",
    english:
    ...
    "moledet-geography":
      "מיפוי לפי מבנה דף מולדת/גיאוגרפיה באתר ומול מסגרת POP של מולדת וחברה ואזרחות, עם הצלבה לעותקי תוכנית בעלים (PDF) בתיקיית תוכנית משרד החינוך. חתימת בעלים או ביקורת ידנית סופית מול כל פרק בתוכנית עדיין לא הושלמה — אין טענה לאישור משרד מלא או לכיסוי שורה־שורה של כל פרק.",
  };
            ...
            <div className="bg-white/5 rounded-2xl border border-white/10 p-6" dir="rtl">
              <div className="prose prose-invert max-w-none">
                <div className="bg-emerald-500/20 border-r-4 border-emerald-500 p-4 rounded-lg mb-6">
                  ...
                  <ul className="list-disc pr-6 space-y-2">
                    ...
                    <li><strong>בקרות פנימיות</strong> — התאמה לדוחות סגירת המתמטיקה והצלבה עם מסמכי PDF לפי כיתה (אוטומטית); ללא חתימת בעלים פעילה</li>
                  </ul>
                </div>
                ...
                <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                  ...
                  <ol className="list-decimal pr-6 space-y-1 mb-4">
                    ...
                    <li>כפל - עד 20</li>
                    <li>השוואה</li>
                    <li>תחושת מספר - שכנים, זוגי/אי-זוגי, השלמה ל-10, עשרות/יחידות, ישר המספרים, מנייה וספירה (כולל השלמת מספר / איזון פשוט בלבד — לא אלגברה פורמלית)</li>
              ...
              <div className="bg-emerald-500/20 border-r-4 border-emerald-500 p-4 rounded-lg">
                ...
                <p className="text-center">
                  המערכת מותאמת לפי כיתה, נושא ורמת קושי: <strong>6 כיתות</strong>, <strong>3 רמות קושי</strong> לכל כיתה, והנושאים כפי שמופיעים למעלה ובדף החשבון. הניסוח נבדק מול מבנה תוכנית הלימודים וקבצי ה-PDF הרשמיים של הכיתות (במסגרת בקרות האתר). חתימת בעלים או בדיקה ידנית סופית עדיין לא הופעלה — אין טענה לאישור רשמי מלא של תוכנית משרד החינוך.
                </p>
              </div>
            </div>
            </div>
