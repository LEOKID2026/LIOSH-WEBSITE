...
export default function Curriculum() {
  ...
  const subjectDescriptions = {
    math:
      "מותאם לפי כיתה, נושא ורמת תרגול (רגיל / מתקדם) — כפי שמוצגים בדף החשבון. בהתאם לנושאים המקובלים בלימודי המקצוע בבתי הספר היסודיים.",
    english:
      "מותאם לפי כיתה, נושא ורמת תרגול (רגיל / מתקדם) — כפי שמוצגים בדף האנגלית. בהתאם לנושאים המקובלים בלימודי המקצוע בבתי הספר היסודיים.",
    science:
      "מותאם לפי כיתה, נושא ורמת תרגול (רגיל בלבד, עם התאמה פנימית) — כפי שמוצגים בדף המדעים. בהתאם לנושאים המקובלים בלימודי המקצוע בבתי הספר היסודיים.",
    geometry:
      "מותאם לפי כיתה, נושא ורמת תרגול (רגיל / מתקדם) — כפי שמוצגים בדף הגאומטריה. בהתאם לנושאים המקובלים בלימודי המקצוע בבתי הספר היסודיים.",
    hebrew:
      "מותאם לפי כיתה, נושא ורמת תרגול (רגיל / מתקדם) — כפי שמוצגים בדף השפה העברית. בהתאם לנושאים המקובלים בלימודי המקצוע בבתי הספר היסודיים.",
    history:
            ...
            <div className="bg-white/5 rounded-2xl border border-white/10 p-6" dir="rtl">
              <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                ...
                <ul className="list-disc pr-6 space-y-2 text-sm text-white/85">
                  ...
                  <li>
                    <strong>2 רמות תרגול</strong> לכל כיתה: רגיל, מתקדם — כפי שמוגדר בדף התרגול
                  </li>
                  <li>
            ...
            <div className="bg-white/5 rounded-2xl border border-white/10 p-6" dir="rtl">
              <div className="prose prose-invert max-w-none">
                ...
                <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                  ...
                  <div className="bg-white/5 p-3 rounded mb-3">
                    ...
                    <div className="text-sm space-y-2">
                      <div><strong>רגיל:</strong> חיבור עד 10 (כולל חיבור בעשרות שלמות ובעשרת השנייה), חיסור עד 10, כפל עד 5×5, השוואה עד 10, תחושת מספר עד 10 (ישר המספרים, מנייה וספירה), שאלות מילוליות עד 10, מעורב</div>
                      <div><strong>רגיל:</strong> חיבור עד 20 (כולל חיבור בעשרות שלמות ובעשרת השנייה), חיסור עד 20, כפל עד 5×5, השוואה עד 20, תחושת מספר עד 20 (ישר המספרים, מנייה וספירה), שאלות מילוליות עד 20, מעורב</div>
                      <div><strong>מתקדם:</strong> חיבור עד 20 (כולל חיבור בעשרות שלמות ובעשרת השנייה), חיסור עד 20, כפל עד 5×5, השוואה עד 20, תחושת מספר עד 20 (ישר המספרים, מנייה וספירה), שאלות מילוליות עד 20, מעורב</div>
                    </div>
                  </div>
                ...
                <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                  ...
                  <div className="bg-white/5 p-3 rounded mb-3">
                    <h4 className="font-semibold mb-2">רמות תרגול (רגיל / מתקדם):</h4>
                    <div className="text-sm space-y-2">
                      <div><strong>רגיל:</strong> חיבור/חיסור עד 50, כפל עד 5×5, חילוק עד 50, שברים חצי/רבע, השוואה עד 1000, שאלות מילוליות עד 100</div>
                      <div><strong>רגיל:</strong> חיבור/חיסור עד 100, כפל עד 10×10, חילוק עד 100, שברים חצי/רבע, השוואה עד 1000, שאלות מילוליות עד 100</div>
                ...
                <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                  ...
                  <div className="bg-white/5 p-3 rounded mb-3">
                    <h4 className="font-semibold mb-2">רמות תרגול (רגיל / מתקדם):</h4>
                    <div className="text-sm space-y-2">
                      <div><strong>רגיל:</strong> חיבור/חיסור עד 200, כפל עד 10 (כולל כפל בעשרות ומאות), חילוק עד 100 (עם שארית), שברים מכנה עד 4, סדרות התחלה עד 20, עשרוניים בסיס עד 50, סימני התחלקות ב-2,5,10, סדר פעולות עם סוגריים, השוואה עד 10000, שאלות מילוליות</div>
                      <div><strong>רגיל:</strong> חיבור/חיסור עד 500, כפל עד 12 (כולל כפל בעשרות ומאות), חילוק עד 144 (עם שארית), שברים מכנה עד 6, סדרות התחלה עד 50, עשרוניים בסיס עד 50, סימני התחלקות ב-2,5,10, סדר פעולות עם סוגריים, השוואה עד 10000, שאלות מילוליות</div>
              ...
              <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                ...
                <div className="bg-white/5 p-3 rounded mb-3">
                  <h4 className="font-semibold mb-2">רמות תרגול (רגיל / מתקדם):</h4>
                  <div className="text-sm space-y-2">
                    <div><strong>רגיל:</strong> חיבור/חיסור עד 1000, כפל עד 20×20 (כולל כפל במאונך), חילוק עד 200 (כולל חילוק ארוך), שברים מכנה עד 6, עיגול עד 999 לעשרות, סימני התחלקות ב-3,6,9, מספרים ראשוניים עד 100, חזקות בסיס עד 10^3, אומדן, תכונות 0 ו-1, גורמים/כפולות עד 100, השוואה עד מיליון</div>
                    <div><strong>רגיל:</strong> חיבור/חיסור עד 5000, כפל עד 30×30 (כולל כפל במאונך), חילוק עד 500 (כולל חילוק ארוך), שברים מכנה עד 8, עיגול עד 9999 למאות, סימני התחלקות ב-3,6,9, מספרים ראשוניים עד 200, חזקות בסיס עד 10^4, אומדן, תכונות 0 ו-1, גורמים/כפולות עד 200, השוואה עד מיליון</div>
                    <div><strong>מתקדם:</strong> חיבור/חיסור עד 10000, כפל עד 50×50 (כולל כפל במאונך), חילוק עד 1000 (כולל חילוק ארוך), שברים מכנה עד 8, עיגול עד 9999 למאות, סימני התחלקות ב-3,6,9, מספרים ראשוניים עד 500, חזקות בסיס עד 10^5, אומדן, תכונות 0 ו-1, גורמים/כפולות עד 500, השוואה עד מיליון</div>
                  </div>
                </div>
                <div className="bg-yellow-500/20 p-3 rounded text-sm">
              ...
              <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                ...
                <div className="bg-white/5 p-3 rounded mb-3">
                  <h4 className="font-semibold mb-2">רמות תרגול (רגיל / מתקדם):</h4>
                  <div className="text-sm space-y-2">
                    <div><strong>רגיל:</strong> חיבור/חיסור עד 10000, כפל עד 50×50, שברים (כולל מספרים מעורבים), אחוזים בסיס עד 400, אומדן, בעיות מילוליות עד 10000</div>
                    <div><strong>רגיל:</strong> חיבור/חיסור עד 50000, כפל עד 100×100, שברים (כולל מספרים מעורבים), אחוזים בסיס עד 1000, אומדן, בעיות מילוליות עד 50000</div>
                    <div><strong>מתקדם:</strong> חיבור/חיסור עד 100000, כפל עד 200×200, שברים (כולל מספרים מעורבים), אחוזים בסיס עד 2000, אומדן, בעיות מילוליות עד 100000, מספרים שליליים</div>
                  </div>
                </div>
                <div className="bg-yellow-500/20 p-3 rounded text-sm">
                  <strong>הערות:</strong> מתחילים מספרים שליליים (במתקדם), אחוזים, בעיות מילוליות, צמצום והרחבה של שברים, חיבור וחיסור שברים. תרגילים דו-שלביים (ברגיל ובמתקדם).
                </div>
              </div>
              ...
              <div className="bg-blue-500/20 border-r-4 border-blue-500 p-4 rounded-lg mb-6">
                ...
                <div className="bg-white/5 p-3 rounded mb-3">
                  <h4 className="font-semibold mb-2">רמות תרגול (רגיל / מתקדם):</h4>
                  <div className="text-sm space-y-2">
                    <div><strong>רגיל:</strong> חיבור/חיסור עד 50000, כפל עד 100×100, חילוק במספר דו-ספרתי, שברים (כולל כפל/חילוק, שבר כמנת חילוק), אחוזים בסיס עד 1000, עשרוניים (כולל כפל/חילוק ב-10/100), קנה מידה, בעיות מילוליות עד 50000</div>
                    <div><strong>רגיל:</strong> חיבור/חיסור עד 100000, כפל עד 200×200, חילוק במספר דו-ספרתי, שברים (כולל כפל/חילוק, שבר כמנת חילוק), אחוזים בסיס עד 2000, עשרוניים (כולל כפל/חילוק ב-10/100, שבר מחזורי), קנה מידה, בעיות מילוליות עד 100000</div>
                ...
                <div className="bg-yellow-500/20 p-3 rounded text-sm">
                  <strong>הערות:</strong> מספרים שליליים (במתקדם). כפל וחילוק שברים, שבר כמנת חילוק, יחס, כפל וחילוק עשרוניים ב-10/100, שבר עשרוני מחזורי, קנה מידה. תרגילים דו-שלביים ומורכבים.
                </div>
              </div>
              ...
              <div className="bg-emerald-500/20 border-r-4 border-emerald-500 p-4 rounded-lg">
                ...
                <p className="text-center">
                  המערכת מותאמת לפי כיתה, נושא ורמת תרגול: <strong>6 כיתות</strong>, <strong>רגיל / מתקדם</strong> (מדעים: רגיל בלבד), והנושאים כפי שמופיעים למעלה ובדף החשבון. בהתאם לנושאים המקובלים בלימודי המקצוע בבתי הספר היסודיים.
                </p>
              </div>
            </div>
            </div>
