...
import { loadGeometryG4TocEntries } from "../../../../../lib/learning-book/load-geometry-g4-pages";
import { useMemo } from "react";

const SUBJECT = "geometry";
const GRADE = "g4";

export default function GeometryG4BookIndex({ batches }) {
  useIOSViewportFix();
    ...
    <Layout>
      ...
      >
        <LearningBookIndexContent
          batches={batches}
          routeBase={GEOMETRY_G4_BOOK_META.routeBase}
        />
      </LearningBookShell>
    </Layout>
  );
