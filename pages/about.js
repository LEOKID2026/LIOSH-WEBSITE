...
const siteFeatures = [
  { phase: "תרגול לפי מקצועות", text: "מתמטיקה, גיאומטריה, עברית, אנגלית, מדעים ומולדת/גאוגרפיה." },
  { phase: "שאלות מותאמות", text: "תרגול לפי כיתה, רמה ונושא, עם דגש על הבנה ולא רק על תשובה נכונה." },
