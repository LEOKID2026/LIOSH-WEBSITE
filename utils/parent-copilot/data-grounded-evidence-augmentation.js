...
export const DATA_GROUNDED_PARENT_SURFACE_SIGNALS_RE =
  /(עברית|חשבון|מתמטיקה|חישוב|אנגלית|מדעים|הנדסה|גאומטריה|מולדת|גאוגרפיה|הבנת\s*הנקרא|קריאה(?!\s+באנגלית)|אוצר\s*מילים|\d+%|\d+\s*שאלות|שאלות\s+בתרגול|לפי\s*הדוח|ממוצע|דיוק)/u;
