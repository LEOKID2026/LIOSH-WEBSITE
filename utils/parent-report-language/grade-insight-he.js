...
export function masteryReallocationHe(topicName) {
  ...
  return name
    ? `נראה שיש שליטה ב${name}; כדאי לשקול להפנות חלק מזמן התרגול לנושא אחר שדורש יותר תשומת לב.`
    : "נראה שיש שליטה בנושא הזה; כדאי לשקול להפנות חלק מזמן התרגול לנושא אחר שדורש יותר תשומת לב.";
}
