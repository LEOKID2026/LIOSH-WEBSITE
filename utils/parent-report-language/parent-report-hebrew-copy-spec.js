...
function adjustInsufficientEvidenceByQHe(text, q) {
  ...
  return "נראה שיש בנושא חלק שכדאי לחזק בתרגול הקרוב.";
}
...
export function homeFallbackHe() {
  return "בבית: כדאי לבצע תרגול קצר וקבוע ולבדוק בדוח הבא אם מופיע דפוס ברור יותר.";
}
...
export function homeBySubjectHe(subjectId) {
  ...
  if (sid === "math" || sid === "geometry") {
    return "בבית: לפתור 3-5 שאלות קצרות באותו נושא ולבקש מהילד להסביר בקול את שלבי הפתרון.";
  }
  if (sid === "hebrew") {
    return "בבית: לקרוא טקסט קצר, לעצור אחרי כל קטע ולבקש מהילד להסביר במילים שלו מה הבין.";
  }
  if (sid === "english") {
    return "בבית: לתרגל 3-5 מילים או משפטים קצרים ולבדוק שהילד מבין את המשמעות ולא רק מזהה את התשובה.";
  }
  if (sid === "science" || sid === "moledet-geography") {
    return "בבית: לחזור על כמה מושגים מרכזיים מהנושא ולבקש מהילד להסביר דוגמה אחת במילים שלו.";
  }
