...
export const PARENT_DIAGNOSTIC_TYPE_LABEL_HE = Object.freeze({
  ...
  insufficient_evidence: "עדיין אין מספיק מידע כדי לקבוע מה בדיוק צריך לחזק בנושא הזה.",
  mixed_low_signal: "עדיין אין מספיק מידע כדי לקבוע מה בדיוק צריך לחזק בנושא הזה.",
