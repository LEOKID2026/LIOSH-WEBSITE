  ...
  math: {
    "M-09": {
      ...
      g3_g4: {
        ...
        goalTextHe:
          "בשבוע הקרוב התמקדו בחיסור רבספרתי במאונך, בפריטה נכונה ובבדיקת התשובה בעזרת חיבור הפוך.",
        intentDescriptionEn:
          "Multi-digit vertical subtraction with regrouping, place-value attention, and inverse addition check.",
      },
      g5_g6: {
        actionTextHe:
          "כדאי לתרגל חיסור במספרים גדולים או בהקשר רבשלבי, עם אומדן לפני הפתרון ובדיקת סבירות בסיום. בקשו מהילד להסביר את דרך החישוב ולא רק לכתוב תשובה.",
        goalTextHe:
    ...
    "M-02": {
      ...
      g3_g4: {
        ...
        goalTextHe:
          "בשבוע הקרוב התמקדו בחיבור רבספרתי במאונך, בנשיאה נכונה ובבדיקת הסבירות של התשובה.",
        intentDescriptionEn:
          "Multi-digit vertical addition with carrying, place-value attention, and reasonableness check.",
      },
      g5_g6: {
        actionTextHe:
          "כדאי לתרגל חיבור במספרים גדולים או בהקשר רבשלבי, עם אומדן לפני הפתרון ובדיקת סבירות בסיום. בקשו מהילד להסביר את דרך החישוב ולא רק לכתוב תשובה.",
        goalTextHe:
    ...
    "M-08": {
      ...
      bucketOverrides: {
        word_problems: {
          ...
          g5_g6: {
            actionTextHe:
              "כדאי לתרגל בעיות מילוליות רבשלביות בעזרת טבלה, תרשים או משוואה פשוטה. בקשו מהילד להסביר את סדר השלבים, מדוע בחר בכל פעולה, ולבדוק בסיום אם התשובה סבירה ביחס לנתוני הבעיה.",
            goalTextHe:
              "בשבוע הקרוב התמקדו בפתרון בעיות רבשלביות: תכנון דרך, בחירת פעולות, הסבר סדר השלבים ובדיקת סבירות התשובה.",
            intentDescriptionEn:
    ...
    "M-01": {
      ...
      bucketOverrides: {
        compare: {
          ...
          g3_g4: {
            actionTextHe:
              "כדאי לתרגל השוואת מספרים רבספרתיים לפי ערך הספרות. בקשו מהילד להתחיל מהספרה בעלת הערך הגבוה ביותר ולהסביר באיזו עמודה נקבע ההבדל.",
            goalTextHe:
        ...
        number_sense: {
          ...
          g3_g4: {
            ...
            goalTextHe:
              "בשבוע הקרוב התמקדו בערך מקום ובפירוק מספרים רבספרתיים לפי הספרות שלהם.",
            intentDescriptionEn:
        ...
        estimation: {
          ...
          g3_g4: {
            actionTextHe:
              "כדאי לתרגל אומדן לפני חישוב במספרים רבספרתיים. בקשו מהילד לעגל את המספרים בקירוב, לשער מה גודל התשובה, ואז לבדוק אם החישוב הסופי סביר.",
            goalTextHe:
              "בשבוע הקרוב התמקדו באומדן לפני חישוב ובבדיקת סבירות של תשובות במספרים רבספרתיים.",
            intentDescriptionEn:
