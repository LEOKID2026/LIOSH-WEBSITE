...
const G2_HARD_QUESTIONS = {
  reading: [
    ...
    {
      question: "קרא את המשפט: 'בבוקר השמש זורחת ומאירה את החצר'",
      answers: [
        "בבוקר השמש זורחת ומאירה את החצר",
        "בבוקר השמש זורחת ומאירה את הצחר",
        "בבוקר השמש זורחט ומאירה את החצר",
        "בבוקר השמש זרחת ומאירה את החצר",
      ],
      correct: 0,
      subtopicId: "g2.short_sentence",
      patternFamily: "g2_read_sentence_morning",
    },
    {
      question: "קרא את המילה: 'ירקות'",
      answers: ["ירקות", "ירקוות", "יירקות", "ירקוט"],
      correct: 0,
      subtopicId: "g2.fluent_words",
      patternFamily: "g2_fluent_yerakot",
    },
    {
      question: "קרא את המשפט: 'הגשם ירד בחוזקה ואנחנו נשארנו בבית'",
      answers: [
        "הגשם ירד בחוזקה ואנחנו נשארנו בבית",
        "הגשם ירד בחוזקה ואנחנו נישארנו בבית",
        "הגשם ירד בחזקה ואנחנו נשארנו בבית",
        "הגשם ירד בחוזקה ואנחנו נשארנו בבייט",
      ],
      correct: 0,
      subtopicId: "g2.short_sentence",
      patternFamily: "g2_read_sentence_rain",
    },
    {
      question: "בקריאה: במשפט שאלה שמתחיל ב'מי' - איזה סימן פיסוק בא בסוף?",
      answers: ["?", ".", "!", ","],
      correct: 0,
      subtopicId: "g2.simple_punctuation_read",
      patternFamily: "g2_punct_question_mark",
    },
    {
      question: "קרא את המילה: 'שקיעה'",
      answers: ["שקיעה", "שקיעא", "שיקיעה", "שקיאה"],
      correct: 0,
      subtopicId: "g2.fluent_words",
      patternFamily: "g2_fluent_shkia",
    },
    {
      question: "קרא את המשפט: 'אמא הכינה עוגה טעימה לחגיגה'",
      answers: [
        "אמא הכינה עוגה טעימה לחגיגה",
        "אמא הכינה עוגה טעימה לחגגה",
        "אמא הכינה עוגה טיעמה לחגיגה",
        "אמא הכינה עוגה טעימה לחגיגא",
      ],
      correct: 0,
      subtopicId: "g2.short_sentence",
      patternFamily: "g2_read_sentence_cake",
    },
    {
      question: "קרא את המשפט: 'הכלב רץ לאורך הגדר ונבח בקול'",
      answers: [
        "הכלב רץ לאורך הגדר ונבח בקול",
        "הכלב רץ לאורך הגדר ונבח בקל",
        "הכלב רץ לאורח הגדר ונבח בקול",
        "הכלב ריץ לאורך הגדר ונבח בקול",
      ],
      correct: 0,
      subtopicId: "g2.short_sentence",
      patternFamily: "g2_read_sentence_dog",
    },
    {
      question: "בקריאה: מה סימן הפיסוק שמבדיל בין פריטים ברשימה?",
      answers: [",", ".", "?", "!"],
      correct: 0,
      subtopicId: "g2.simple_punctuation_read",
      patternFamily: "g2_punct_comma_list",
    },
    {
      question: "קרא את המשפט: 'בשיעור ציור הילדים צבעו ועיטרו את הדפים'",
      answers: [
        "בשיעור ציור הילדים צבעו ועיטרו את הדפים",
        "בשיעור ציור הילדים ציבעו ועיטרו את הדפים",
        "בשיעור ציור הילדים צבעו ועיטרו את הדפיים",
        "בשיעור ציור הילידים צבעו ועיטרו את הדפים",
      ],
      correct: 0,
      subtopicId: "g2.short_sentence",
      patternFamily: "g2_read_sentence_art_class",
    },
    {
      question: "קרא את המילה: 'מספריים'",
      answers: ["מספריים", "מיספריים", "מספרים", "מספרייים"],
      correct: 0,
      subtopicId: "g2.fluent_words",
      patternFamily: "g2_fluent_misparaim",
    },
    {
      question: "קרא את המשפט: 'לפני השינה אנחנו מצחצחים שיניים ולובשים פיג׳מה'",
      answers: [
        "לפני השינה אנחנו מצחצחים שיניים ולובשים פיג׳מה",
        "לפני השינה אנחנו מצחצחים שינייים ולובשים פיג׳מה",
        "לפני השינה אנחנו מציחצחים שיניים ולובשים פיג׳מה",
        "לפני השינה אנחנו מצחצחים שיניים ולבושים פיג׳מה",
      ],
      correct: 0,
      subtopicId: "g2.short_sentence",
      patternFamily: "g2_read_sentence_bedtime",
    },
    {
      question: "קרא את המשפט: 'בסוף השנה קיבלנו תעודות ונפרדנו מהמורה'",
      answers: [
        "בסוף השנה קיבלנו תעודות ונפרדנו מהמורה",
        "בסוף השנה קיבלנו תיעודות ונפרדנו מהמורה",
        "בסוף השנה קיבלנו תעודות וניפרדנו מהמורה",
        "בסוף השנה קיבלנו תעודות ונפרדנו ממורה",
      ],
      correct: 0,
      subtopicId: "g2.short_sentence",
      patternFamily: "g2_read_sentence_year_end",
    },
    {
      question: "קרא את המשפט: 'הגננת פתחה את הדלת ואמרה שלום לילדים'",
      answers: [
        "הגננת פתחה את הדלת ואמרה שלום לילדים",
        "הגננת פיתחה את הדלת ואמרה שלום לילדים",
        "הגנת פתחה את הדלת ואמרה שלום לילדים",
        "הגננת פתחה את הדלת ואמרה שילום לילדים",
      ],
      correct: 0,
      subtopicId: "g2.short_sentence",
      patternFamily: "g2_read_sentence_ganenet",
    },
  ],
  comprehension: [
...
const G3_HARD_QUESTIONS = {
  ...
  writing: [
    ...
    {
      question: "בחרו מילת קישור מתאימה: 'הכנתי את השיעורים' ____ 'יצאתי לשחק.'",
      answers: ["ואז", "אבל", "כי", "למרות"],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_sequence_play",
      subtype: "temporal_then",
    },
    {
      question: "בחרו מילת קישור: 'הגשם ירד בחוזקה' ____ 'נשארנו בפנים.'",
      answers: ["לכן", "ואז", "אבל", "ולמרות"],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_cause_rain",
      subtype: "causal",
    },
    {
      question: "איזה משפט כולל מילת קישור שמבטאת ניגוד?",
      answers: [
        "אהבתי את הסיפור, אבל הסוף היה עצוב",
        "יצאנו לטיול ואז אכלנו ארוחת צהריים",
        "למדתי כי רציתי לדעת יותר",
        "הגענו מוקדם לכן ישבנו ראשונים",
      ],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_contrast_identify",
      subtype: "contrast_aval",
    },
    {
      question: "מה התפקיד של פסקה חדשה בחיבור?",
      answers: [
        "לסמן מעבר לרעיון חדש",
        "לסמן שהכתיבה נגמרה",
        "לסמן שטעינו",
        "לסמן שצריך לחזור על אותו רעיון",
      ],
      correct: 0,
      subtopicId: "g3.paragraph_structure",
      patternFamily: "g3_para_new_idea",
      subtype: "structure_awareness",
    },
    {
      question: "מה מבנה הנכון של חיבור סיפורי בכיתה ג׳?",
      answers: [
        "פתיחה שמציגה את המצב, אמצע שבו קורה משהו, סוף שמסיים",
        "רשימת עובדות ללא רגשות",
        "שאלות בלבד ללא תשובות",
        "ציטוט ממקור ואחריו חתימה",
      ],
      correct: 0,
      subtopicId: "g3.paragraph_structure",
      patternFamily: "g3_story_structure",
      subtype: "narrative_arc",
    },
    {
      question: "בחיבור — איזה משפט פתיחה מתאים לסיפור על יום בלתי נשכח?",
      answers: [
        "בבוקר שגרתי, משהו בלתי צפוי שינה את כל היום.",
        "הוא בא לבית ספר.",
        "1+1=2 כי המספרים גדלים.",
        "אין לי מה לכתוב היום.",
      ],
      correct: 0,
      subtopicId: "g3.paragraph_structure",
      patternFamily: "g3_opening_sentence_story",
      subtype: "hook_opening",
    },
    {
      question: "בחרו את המשפט עם מילת קישור שמבטאת סיבה:",
      answers: [
        "לא יצאתי לחצר כי ירד גשם",
        "לא יצאתי לחצר ואז ירד גשם",
        "לא יצאתי לחצר אבל ירד גשם",
        "לא יצאתי לחצר ואחר כך ירד גשם",
      ],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_ki_cause",
      subtype: "causal_ki",
    },
    {
      question: "בחרו מילת קישור מתאימה: 'הייתי עייף' ____ 'הלכתי לישון מוקדם.'",
      answers: ["לכן", "אבל", "ואחר כך", "למרות ש"],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_tired_sleep",
      subtype: "causal_result",
    },
    {
      question: "מה פירוש 'פסקת פתיחה' בחיבור?",
      answers: [
        "הפסקה הראשונה שמציגה את הנושא ומשכנעת לקרוא",
        "הפסקה האחרונה שמסכמת הכל",
        "כל פסקה שמתחילה ב-א׳",
        "פסקה שאין בה מילים",
      ],
      correct: 0,
      subtopicId: "g3.paragraph_structure",
      patternFamily: "g3_intro_paragraph_def",
      subtype: "meta_structure",
    },
    {
      question: "בחרו את הניסוח שמתאים לסיום חיבור סיפורי:",
      answers: [
        "ומאז הבנתי שחשוב לשמוע לאחרים.",
        "זהו. נגמר.",
        "פסקה 1, פסקה 2, פסקה 3.",
        "ואחר כך ואחר כך ואחר כך.",
      ],
      correct: 0,
      subtopicId: "g3.paragraph_structure",
      patternFamily: "g3_closing_sentence_lesson",
      subtype: "moral_close",
    },
    {
      question: "מה ההבדל בין 'ניגוד' ל'סיבה' כשבוחרים מילת קישור?",
      answers: [
        "ניגוד — 'אבל/למרות'; סיבה — 'כי/לכן'",
        "ניגוד — 'כי'; סיבה — 'אבל'",
        "שניהם מבטאים תוצאה",
        "אין הבדל — שתיהן מחברות משפטים",
      ],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_contrast_vs_cause",
      subtype: "meta_grammar",
    },
    {
      question: "בחרו את המשפט עם השגיאה בשימוש במילת קישור:",
      answers: [
        "הלכתי לחנות אבל קניתי לחם",
        "הלכתי לחנות לכן קניתי לחם",
        "הלכתי לחנות כי רציתי לחם",
        "הלכתי לחנות ואז קניתי לחם",
      ],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_wrong_but",
      subtype: "error_detection",
    },
    {
      question: "בחרו מילת קישור מתאימה: 'פגשתי חבר' ____ 'שוחחנו על הסרט.'",
      answers: ["ואחר כך", "אבל", "כי", "למרות ש"],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_sequence_chat",
      subtype: "temporal_sequence",
    },
    {
      question: "בחיבור — מה חשוב להכניס לפסקת הגוף?",
      answers: [
        "פרטים, דוגמאות ותיאורים שתומכים ברעיון הראשי",
        "רק שמות של אנשים",
        "רק מספרים וסטטיסטיקות",
        "רק ציטוטים ישירים",
      ],
      correct: 0,
      subtopicId: "g3.paragraph_structure",
      patternFamily: "g3_body_para_content",
      subtype: "detail_support",
    },
    {
      question: "בחרו מילת קישור: 'הכנו את הפרויקט' ____ 'הצגנו אותו בכיתה.'",
      answers: ["ולאחר מכן", "אבל", "כי", "למרות"],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_project_present",
      subtype: "sequential_after",
    },
    {
      question: "מה פירוש 'מסר' בסיפור ספרותי?",
      answers: [
        "הרעיון הכללי שהכותב רוצה להעביר לקורא",
        "שם הגיבור הראשי",
        "מספר המילים בסיפור",
        "הכותרת של הסיפור בלבד",
      ],
      correct: 0,
      subtopicId: "g3.paragraph_structure",
      patternFamily: "g3_message_def",
      subtype: "literary_term",
    },
    {
      question: "בחרו מילת קישור מתאימה: 'חיכינו זמן רב' ____ 'המורה הגיעה בסוף.'",
      answers: ["עד ש", "אבל", "לכן", "כי"],
      correct: 0,
      subtopicId: "g3.connector_use_choice",
      patternFamily: "g3_connector_wait_arrive",
      subtype: "temporal_until",
    },
    {
      question: "בחרו את המשפט שמכיל תיאור עשיר ומתאים לחיבור ספרותי:",
      answers: [
        "עלי הסתיו הכתומים נפלו בשקט על המדרכה הלחה.",
        "הגיע סתיו.",
        "עלים נפלו.",
        "היה קר.",
      ],
      correct: 0,
      subtopicId: "g3.paragraph_structure",
      patternFamily: "g3_rich_description",
      subtype: "descriptive_language",
    },
  ],
  grammar: [
...
const G4_HARD_QUESTIONS = {
  ...
  writing: [
    ...
    {
      question: "בחיבור טיעוני — מהו המרכיב שחייב להופיע כדי שטענה תהיה משכנעת?",
      answers: [
        "נימוק התומך בטענה",
        "ציור או תמונה",
        "שם המחבר בלבד",
        "כמה שיותר מילים ארוכות",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_argument_must_have_reason",
      subtype: "argument_component",
    },
    {
      question: "בכתיבת דעה — מה ההבדל בין 'טענה' ל'נימוק'?",
      answers: [
        "טענה — מה שאתה חושב; נימוק — למה אתה חושב כך",
        "טענה — כותרת; נימוק — שם הכותב",
        "טענה — מספר המילים; נימוק — ציור",
        "אין הבדל",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_claim_vs_reason",
      subtype: "argument_terms",
    },
    {
      question: "בחיבור טיעוני — איפה מניחים בדרך כלל את הטענה המרכזית?",
      answers: [
        "בפסקת הפתיחה, לאחר משפט הפתיחה",
        "רק בסוף החיבור",
        "רק באמצע, בלי פסקת פתיחה",
        "לא צריך טענה בפסקת הפתיחה",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_thesis_placement",
      subtype: "structure_placement",
    },
    {
      question: "בחרו את המשפט שמציג דעה מנומקת:",
      answers: [
        "לדעתי ספרים חשובים כי הם מרחיבים אוצר מילים ומגבירים דמיון.",
        "ספרים.",
        "אני אוהב ספרים.",
        "ספרים הם דבר.",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_opinion_with_reason",
      subtype: "opinion_sentence",
    },
    {
      question: "בחיבור — מתי כדאי לכתוב 'לדוגמה'?",
      answers: [
        "כשמביאים מקרה ספציפי שמדגים טענה כללית",
        "כשמציגים את שם הכותב",
        "כשסוגרים את החיבור",
        "כשאין מה לכתוב",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_for_example_usage",
      subtype: "discourse_marker",
    },
    {
      question: "בדוח או בהסבר — מה מאפיין שפה רשמית?",
      answers: [
        "משפטים שלמים, ללא קיצורים וללא שפת דיבור",
        "ריבוי מילות סלנג",
        "ריבוי סימני קריאה",
        "כתיבה רק בגוף ראשון",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_formal_register_features",
      subtype: "register_identify",
    },
    {
      question: "בחיבור הסברתי — מה תפקיד פסקת הסיום?",
      answers: [
        "לסכם את הנקודות העיקריות ולהשאיר רושם סופי",
        "להציג רעיון חדש לחלוטין",
        "לחזור מילה במילה על הפתיחה",
        "לרשום את תוכן העניינים",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_conclusion_role",
      subtype: "conclusion_purpose",
    },
    {
      question: "בחרו את הניסוח הרשמי ביותר:",
      answers: [
        "מצ׳יק, אני חושב שיש בעיה.",
        "לכבוד הנהלת בית הספר, ברצוני להעלות נושא.",
        "אהלן, צריך לתקן משהו.",
        "שלום, כן, יש דבר.",
      ],
      correct: 1,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_formal_opening_letter",
      subtype: "register_choice",
    },
    {
      question: "בחיבור — מה הבעיה במשפט: 'הוא אמר שהמשחק היה נהדר וגם הוא אמר שהם ניצחו ועוד הוא אמר שהיה כיף'?",
      answers: [
        "חזרה מיותרת על 'הוא אמר' — אפשר לגוון את הפתיחה",
        "המשפט קצר מדי",
        "אין נושא למשפט",
        "המשפט לא מתאר שום דבר",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_repetition_issue",
      subtype: "style_repetition",
    },
    {
      question: "בהסבר — מה תפקידה של דוגמה?",
      answers: [
        "להפוך רעיון מופשט לקונקרטי ומובן יותר",
        "לסיים את ההסבר",
        "להוסיף נושא שלא נלמד",
        "להארך את הטקסט ללא מטרה",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_example_function",
      subtype: "example_role",
    },
    {
      question: "בחרו מילת קישור שמציגה ניגוד: 'התכוננתי היטב למבחן' ____ 'לא עניתי על כל השאלות.'",
      answers: ["אך", "לכן", "כי", "ואחר כך"],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_connector_ach_contrast",
      subtype: "contrast_connector",
    },
    {
      question: "מה ההבדל בין טקסט הסברתי לטקסט טיעוני?",
      answers: [
        "הסברתי מלמד איך/למה; טיעוני משכנע לדעה",
        "הסברתי תמיד ארוך יותר",
        "טיעוני לא כולל עובדות",
        "אין הבדל בין שני הסוגים",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_expository_vs_argument",
      subtype: "genre_distinction",
    },
    {
      question: "בחיבור — מתי משתמשים במילה 'לסיכום'?",
      answers: [
        "בתחילת פסקת הסיום, לפני חזרה על הנקודות העיקריות",
        "בתחילת כל פסקה",
        "רק כשהחיבור ארוך מאוד",
        "רק אם יש יותר מחמש פסקאות",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_to_summary_usage",
      subtype: "discourse_close",
    },
    {
      question: "בחיבור — מה הבעיה ב'לדעתי הכלב הוא החיה הכי טובה כי אני אוהב אותו'?",
      answers: [
        "הנימוק ('כי אני אוהב') הוא סובייקטיבי ולא תומך בטענה הכללית",
        "הכלב לא מוזכר בכותרת",
        "המשפט קצר מדי",
        "אין טענה",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_weak_reason_personal",
      subtype: "reason_quality",
    },
    {
      question: "בחרו את המשפט שיתאים כמשפט ראשון בפסקת גוף שמסבירה יתרון של קריאה:",
      answers: [
        "קריאה מרחיבה את אוצר המילים ומשפרת את יכולת הביטוי.",
        "קריאה.",
        "גם לי יש ספרים.",
        "בסוף, קריאה.",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_topic_sentence_reading",
      subtype: "topic_sentence",
    },
    {
      question: "בחרו מילת קישור מתאימה: 'הבנתי את החומר' ____ 'הצלחתי במבחן.'",
      answers: ["לכן", "אבל", "כי", "אם כי"],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_connector_understood_succeeded",
      subtype: "result_connector",
    },
    {
      question: "בחיבור — מה הבעיה בפסקה שמכילה שלושה רעיונות שונים ללא חיבור ביניהם?",
      answers: [
        "חסר לכידות — כל רעיון צריך להיות בפסקה נפרדת עם חיבור ברור",
        "הפסקה ארוכה מדי — צריך רק רעיון אחד",
        "אין בעיה — ריבוי רעיונות עדיף",
        "רק הרעיון האחרון חשוב",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_coherence_multiple_ideas",
      subtype: "paragraph_coherence",
    },
    {
      question: "בחיבור טיעוני — מה תפקיד 'דוגמה מהחיים'?",
      answers: [
        "לחזק את הטענה באמצעות מקרה קונקרטי",
        "להחליף את הטענה לגמרי",
        "להוסיף מידע שאינו קשור לנושא",
        "להתחיל חיבור חדש",
      ],
      correct: 0,
      subtopicId: "g4.genre_appropriate_language",
      patternFamily: "g4_real_life_example",
...
const G5_HARD_QUESTIONS = {
  ...
  writing: [
    ...
    {
      question: "מה 'טענה נגדית' (counterargument) בחיבור טיעוני?",
      answers: [
        "דעה שמתנגדת לטענה שלך, שאת/ה צריך להתמודד איתה",
        "תמיד שגיאה שצריך למחוק",
        "ציטוט מהמקור הראשי",
        "פסקת פתיחה בלבד",
      ],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_counterargument_def",
      subtype: "argument_component",
    },
    {
      question: "בחיבור מדעי — מה ההבדל בין 'השערה' ל'מסקנה'?",
      answers: [
        "השערה — ניחוש מוקדם; מסקנה — תוצאה מבוססת על ניסוי/ראיה",
        "השערה — תוצאה; מסקנה — שאלת מחקר",
        "אין הבדל ביניהן",
        "השערה תמיד נכונה; מסקנה תמיד שגויה",
      ],
      correct: 0,
      subtopicId: "g5.genre_variety",
      patternFamily: "g5_hypothesis_vs_conclusion",
      subtype: "science_writing",
    },
    {
      question: "בחרו מילת קישור שמציגה ויתור ('admittedly'):",
      answers: ["אמנם... אולם", "לכן", "כי", "ואז"],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_connector_admittedly",
      subtype: "concession_connector",
    },
    {
      question: "בחיבור — מה ההבדל בין 'פסקת גוף' ל'פסקת פתיחה'?",
      answers: [
        "פסקת פתיחה מציגה את הנושא; פסקת גוף מפתחת ומוכיחה טענה ספציפית",
        "פסקת גוף תמיד ארוכה יותר",
        "פסקת פתיחה לא חייבת טענה",
        "אין הבדל — שתיהן מציגות רעיונות חדשים",
      ],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_intro_vs_body_para",
      subtype: "structure_compare",
    },
    {
      question: "כשכותבים 'לפי [שם הכותב]' — מה תפקיד הפסקה הזאת?",
      answers: [
        "לייחס טענה למקורה ולהראות שנשענים על סמכות",
        "לחזור על מה שכבר נאמר",
        "להוסיף רשימת מקורות בסוף",
        "לפתוח בנושא חדש",
      ],
      correct: 0,
      subtopicId: "g5.genre_variety",
      patternFamily: "g5_citing_author_role",
      subtype: "attribution",
    },
    {
      question: "בחיבור — מה 'משפט נושא' (topic sentence)?",
      answers: [
        "המשפט הראשון בפסקה שמציג את הרעיון של הפסקה",
        "כל משפט שמכיל שם עצם",
        "המשפט האחרון בפסקה",
        "כותרת החיבור",
      ],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_topic_sentence_def",
      subtype: "paragraph_structure",
    },
    {
      question: "בחרו את המשפט שמציג הפרכה נאותה לטענה 'הטכנולוגיה מזיקה':",
      answers: [
        "אמנם יש סיכונים, אולם הטכנולוגיה גם מאפשרת תקשורת ולמידה בכל מקום.",
        "הטכנולוגיה לא מזיקה.",
        "כולם משתמשים בטכנולוגיה.",
        "הטכנולוגיה יקרה.",
      ],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_rebuttal_tech",
      subtype: "rebuttal_example",
    },
    {
      question: "בחיבור אקדמי — מה 'ניסוח מדויק'?",
      answers: [
        "שימוש במילים שמביעות בדיוק את הכוונה ללא עמימות",
        "שימוש במילים קצרות בלבד",
        "כתיבה רק בגוף שלישי",
        "כתיבה ללא סימני פיסוק",
      ],
      correct: 0,
      subtopicId: "g5.genre_variety",
      patternFamily: "g5_precise_language_def",
      subtype: "academic_style",
    },
    {
      question: "בחיבור טיעוני — מה ה'מסקנה' צריכה להכיל?",
      answers: [
        "חזרה על הטענה המרכזית עם ניסוח מעט שונה, ואפשרות לחשיבה לעתיד",
        "רשימת כל הנקודות כמו שנכתבו",
        "שאלות חדשות בלבד",
        "מחיקת הטיעון הראשי",
      ],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_conclusion_contains",
      subtype: "conclusion_components",
    },
    {
      question: "בחרו את ניסוח הטענה המרכזית שהכי ניתן להוכחה:",
      answers: [
        "שיעורי בית מרובים עלולים לפגוע באיכות השינה של תלמידים.",
        "שיעורי בית זה רע.",
        "תלמידים לא אוהבים שיעורי בית.",
        "שיעורי בית טובים.",
      ],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_thesis_arguable",
      subtype: "thesis_quality",
    },
    {
      question: "בחיבור — מה 'עדות' בהקשר של טיעון?",
      answers: [
        "נתון, ציטוט או דוגמה שמחזקים את הטענה",
        "כל משפט בחיבור",
        "שם הכותב",
        "אורך הפסקה",
      ],
      correct: 0,
      subtopicId: "g5.genre_variety",
      patternFamily: "g5_evidence_def",
      subtype: "evidence_concept",
    },
    {
      question: "בחיבור מדעי — למה לא כותבים 'אני חשבתי שהניסוי יצליח'?",
      answers: [
        "שפה מדעית אקדמית מעדיפה ניסוח אובייקטיבי בגוף שלישי",
        "כי ניסויים תמיד נכשלים",
        "כי 'אני' לא מופיע בעברית",
        "כי גוף ראשון אסור בכל טקסט",
      ],
      correct: 0,
      subtopicId: "g5.genre_variety",
      patternFamily: "g5_science_first_person_avoid",
      subtype: "register_science",
    },
    {
      question: "בחרו את הניסוח שמחזק טענה בסגנון אקדמי:",
      answers: [
        "מחקר שנערך בישראל מצא ש-70% מהתלמידים שמחים יותר בבית ספר עם הפסקות ארוכות.",
        "הרבה ילדים אוהבים הפסקות.",
        "כולם יודעים שהפסקות חשובות.",
        "ברור שהפסקות טובות.",
      ],
      correct: 0,
      subtopicId: "g5.genre_variety",
      patternFamily: "g5_academic_evidence_example",
      subtype: "evidence_academic",
    },
    {
      question: "בחיבור — מה הבעיה בפסקה שמתחילה בנושא אחד ומסיימת בנושא שלגמרי אחר?",
      answers: [
        "חסר לכידות פנימית — פסקה צריכה לדון ברעיון אחד בלבד",
        "הפסקה ארוכה מדי",
        "אין בעיה — ריבוי נושאים בפסקה זה מעניין",
        "הסוף של הפסקה לא חשוב",
      ],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_para_unity_issue",
      subtype: "paragraph_unity",
    },
    {
      question: "בחרו את ניסוח ה'מסקנה' הטובה ביותר לחיבור על חשיבות ספריות:",
      answers: [
        "לסיכום, ספריות הן מרכז תרבותי חיוני שיש לשמר ולפתח.",
        "ספריות. זהו.",
        "ספריות קיימות.",
        "בסוף, כולם צריכים ספרים.",
      ],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_conclusion_library",
      subtype: "conclusion_quality",
    },
    {
      question: "בחיבור — מה תפקיד ה'הקדמה' (פסקת פתיחה)?",
      answers: [
        "להציג את הנושא, לעורר עניין, ולהציג את הטענה המרכזית",
        "לחזור על הסיכום",
        "לרשום את שמות המקורות",
        "לפתוח ברשימת כל הנקודות",
      ],
      correct: 0,
      subtopicId: "g5.full_composition_scaffold_choice",
      patternFamily: "g5_intro_function",
      subtype: "intro_purpose",
    },
  ],
  grammar: [
...
const G6_HARD_QUESTIONS = {
  ...
  comprehension: [
    ...
    {
      question: "כותב טוען: 'כולם יודעים ש...' — מה הבעיה הביקורתית?",
      answers: [
        "הכללה ריקה ללא ביסוס — 'כולם יודעים' לא מחליף ראיה",
        "הכותב צודק, אם כולם יודעים זה מספיק",
        "רק הדקדוק לא נכון",
        "אין בעיה בפתיחת טיעון כך",
      ],
      correct: 0,
      subtopicId: "g6.critical_evaluation_light",
      patternFamily: "g6_crit_everyone_knows",
      subtype: "unsupported_claim",
    },
    {
      question: "מאמר מציג שני מחקרים סותרים ובוחר להתעלם מאחד מהם. מה הבעיה?",
      answers: [
        "הצגה חלקית של הנתונים — בחירה מגמתית מחלישה את האמינות",
        "זה תמיד קביל בכתיבה אקדמית",
        "מחקר סותר תמיד שגוי",
        "אין חובה לציין מחקרים שסותרים",
      ],
      correct: 0,
      subtopicId: "g6.critical_evaluation_light",
      patternFamily: "g6_crit_cherry_pick",
      subtype: "selective_evidence",
    },
    {
      question: "טקסט פרסומי אומר: 'רופאים המליצו על המוצר'. מה חסר לצורך הערכה ביקורתית?",
      answers: [
        "פרטים: אילו רופאים, כמה, ומה היו התנאים",
        "צריך לסמוך על כל רופא",
        "מספיק שנאמר 'רופאים'",
        "רק שם המוצר חשוב",
      ],
      correct: 0,
      subtopicId: "g6.critical_evaluation_light",
      patternFamily: "g6_crit_vague_authority",
      subtype: "vague_source",
    },
    {
      question: "הטקסט: 'מחקר אחד מצא שתלמידים שישנים יותר מצליחים יותר.' מה מגביל את המסקנה?",
      answers: [
        "מחקר אחד לא מספיק להכללה — צריך שכפול עם מדגמים שונים",
        "מחקר אחד מספיק תמיד",
        "שינה לא קשורה להצלחה",
        "אין מגבלה — זה ניסוי מדעי",
      ],
      correct: 0,
      subtopicId: "g6.evidence_from_text",
      patternFamily: "g6_crit_single_study",
      subtype: "generalization_limit",
    },
    {
      question: "כותב מביא נתון שנכון אבל לא רלוונטי לטענה. מה הבעיה?",
      answers: [
        "ראיה שאינה קשורה לא תומכת בטענה — יש לבדוק רלוונטיות",
        "כל נתון נכון הוא ראיה טובה",
        "רלוונטיות לא חשובה בטיעון",
        "הבעיה היא רק בעיצוב הטקסט",
      ],
      correct: 0,
      subtopicId: "g6.critical_evaluation_light",
      patternFamily: "g6_crit_irrelevant_evidence",
      subtype: "relevance_check",
    },
    {
      question: "מחקר השווה שתי קבוצות, אבל הקבוצות היו שונות בגיל. מה הבעיה?",
      answers: [
        "משתנה מתערב (גיל) יכול להסביר את ההבדל — ההשוואה לא הוגנת",
        "זה בסדר כי גיל לא משנה",
        "ההשוואה תמיד הוגנת אם המחקר פורסם",
        "אין בעיה בהשוואה כזו",
      ],
      correct: 0,
      subtopicId: "g6.evidence_from_text",
      patternFamily: "g6_crit_confound_variable",
      subtype: "confounding_variable",
    },
    {
      question: "בטקסט פרסומי: 'המוצר שלנו טוב ב-40%.' מה שאלה ביקורתית חשובה?",
      answers: [
        "40% טוב ממה? בהשוואה לאיזה מוצר ובאיזה מדד?",
        "כמה עולה המוצר?",
        "מי כתב את הפרסומת?",
        "מה צבע המוצר?",
      ],
      correct: 0,
      subtopicId: "g6.critical_evaluation_light",
      patternFamily: "g6_crit_40percent_baseline",
      subtype: "comparison_baseline",
    },
    {
      question: "כותב מאמר מביא נתון ישן (מלפני 20 שנה) כהוכחה לתופעה של היום. מה הבעיה?",
      answers: [
        "נתונים ישנים עשויים לא לשקף את המצב הנוכחי — צריך נתונים עדכניים",
        "נתונים ישנים תמיד נכונים",
        "אין חובה לציין שנת המחקר",
        "ישן אמין יותר מחדש",
      ],
      correct: 0,
      subtopicId: "g6.critical_evaluation_light",
      patternFamily: "g6_crit_outdated_data",
      subtype: "data_currency",
    },
    {
      question: "בטקסט טיעוני — מה 'יתרה מזאת' (furthermore) מסמן?",
      answers: [
        "הוספת טענה חזקה נוספת שמחזקת את הקודמת",
        "ניגוד לטענה שלפניה",
        "פתיחת חיבור חדש",
        "סיום הטיעון",
      ],
      correct: 0,
      subtopicId: "g6.evidence_from_text",
      patternFamily: "g6_connector_furthermore",
      subtype: "discourse_marker",
    },
    {
      question: "הטקסט מביא ראיות רק ממקור אחד שיש לו עניין ישיר בתוצאה. מה הבעיה הביקורתית?",
      answers: [
        "ניגוד עניינים — מקור בעל אינטרס עלול להציג נתונים מגמתיים",
        "כל מקור יכול להיות אמין",
        "אין בעיה אם המקור ידוע",
        "ניגוד עניינים לא משפיע על אמינות",
      ],
      correct: 0,
      subtopicId: "g6.critical_evaluation_light",
      patternFamily: "g6_crit_conflict_interest",
      subtype: "source_bias",
    },
    {
      question: "כותב כותב: 'אם לא נפעל עכשיו — הכל יתמוטט.' מה הפגם הלוגי?",
      answers: [
        "פחד מוגזם (scaremongering) — הכתיב תרחיש קיצוני ללא ביסוס",
        "המשפט קצר מדי",
        "הנושא לא רלוונטי",
        "אין פגם — זהו ניסוח לגיטימי",
      ],
      correct: 0,
      subtopicId: "g6.critical_evaluation_light",
      patternFamily: "g6_crit_scaremongering",
      subtype: "logical_fallacy",
    },
    {
      question: "בטקסט: 'מחקר מצא קשר בין צפייה בטלוויזיה להישגים נמוכים.' מה אסור להסיק ישירות?",
      answers: [
        "שהטלוויזיה גורמת להישגים נמוכים — קשר לא מוכיח סיבתיות",
        "שיש קשר כלשהו",
        "שהמחקר כתב משהו",
        "שתלמידים צופים בטלוויזיה",
      ],
      correct: 0,
      subtopicId: "g6.evidence_from_text",
      patternFamily: "g6_crit_correlation_causation",
      subtype: "correlation_vs_causation",
    },
    {
      question: "הטקסט מתאר קשיים, אבל לא מציג נתונים שמגבים את הטענה. מה נחוץ?",
      answers: [
        "ראיות מוסכמות — נתונים, ציטוטים ממקורות אמינים",
        "רק תיאורים רגשיים מספיקים",
        "הכותב אמין ולכן אין צורך בנתונים",
        "טיעון רגשי תמיד חזק יותר",
      ],
      correct: 0,
      subtopicId: "g6.evidence_from_text",
      patternFamily: "g6_crit_need_evidence",
      subtype: "evidence_requirement",
    },
    {
      question: "במאמר ארוך — מה 'ציטוט ישיר' לעומת 'פרפרזה'?",
      answers: [
        "ציטוט ישיר — מילותיו המדויקות של המקור במרכאות; פרפרזה — רעיון המקור במילים שלך",
        "ציטוט ישיר — קצר; פרפרזה — ארוכה",
        "אין הבדל — שניהם מביאים מקורות",
        "פרפרזה — תמיד עדיפה",
      ],
      correct: 0,
      subtopicId: "g6.evidence_from_text",
      patternFamily: "g6_quote_vs_paraphrase",
      subtype: "citation_types",
    },
    {
      question: "קורא מוצא שכותב משתמש בשפה רגשית חזקה ('זוהי אסון!') בטקסט שאמור להיות מדעי. מה הבעיה?",
      answers: [
        "שפה רגשית בטקסט מדעי מחלישה את האובייקטיביות",
        "שפה רגשית תמיד חזקה יותר",
        "רגש ומדע ניתן לשלב ללא בעיה",
        "אין הבדל בין שפה מדעית לשפה רגשית",
      ],
      correct: 0,
      subtopicId: "g6.critical_evaluation_light",
      patternFamily: "g6_crit_emotional_language_science",
      subtype: "tone_objectivity",
    },
    {
      question: "מחקר מצא שתוצאה אחת הייתה שונה בין שני בתי ספר. מה מגבלת המסקנה?",
      answers: [
        "שני בתי ספר לא מייצגים את כלל האוכלוסייה — אי אפשר להכליל",
        "שני בתי ספר הם מדגם מספיק",
        "מספר המדגם לא קשור למסקנה",
        "ממצא שונה אומר שהמחקר שגוי",
      ],
      correct: 0,
      subtopicId: "g6.evidence_from_text",
      patternFamily: "g6_crit_small_sample_two_schools",
      subtype: "generalization_sample",
    },
  ],
  writing: [
    { question: "איך כותבים כתיבה אקדמית?", answers: ["כתיבה מקצועית עם מחקר וציטוטים", "רק מילה", "רק אות", "ללא כתיבה"], correct: 0 },
