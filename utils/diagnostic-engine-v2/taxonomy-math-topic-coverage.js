 ...
 */
const DEFINITIONS = [
  ["M-11", "compare", "math_compare_relation_error", "השוואת מספרים", "בחירת סימן השוואה לא נכון", "cmp"],
  ["M-12", "scale", "math_scale_operation_error", "קנה מידה", "בחירת פעולה לא נכונה בקנה מידה", "scale_"],
  ["M-13", "division", "math_division_operation_error", "חילוק", "כפל במקום חילוק", "div"],
  ["M-14", "division_with_remainder", "math_remainder_error", "חילוק עם שארית", "מנה או שארית שאינן מתאימות לתרגיל החילוק", "div_with_remainder"],
  ["M-15", "decimals", "math_decimal_place_shift_error", "מספרים עשרוניים", "הזזת הנקודה העשרונית למקום שגוי", "dec_"],
  ["M-16", "sequences", "math_sequence_step_error", "סדרות", "יישום לא עקבי של חוקיות הסדרה", "seq_"],
  ["M-17", "percentages", "math_percentage_base_error", "אחוזים", "בלבול בין האחוז, השלם והחלק", "perc_"],
  ["M-18", "ratio", "math_ratio_order_error", "יחס", "היפוך סדר היחס או שינוי היחס", "ratio_"],
  ["M-19", "equations", "math_equation_inverse_error", "משוואות", "שימוש לא נכון בפעולה הפוכה במשוואה", "eq_"],
  ["M-20", "order_of_operations", "math_operation_order_error", "סדר פעולות", "חישוב לפי סדר הכתיבה במקום לפי סדר הפעולות", "order_"],
  ["M-21", "divisibility", "math_divisibility_classification_error", "סימני התחלקות", "מסקנה שגויה לאחר בדיקת כלל התחלקות", "divisibility"],
  ["M-22", "prime_composite", "math_prime_composite_classification_error", "ראשוניים ופריקים", "בלבול בין מספר ראשוני למספר פריק", "prime_composite"],
  ["M-23", "powers", "math_power_as_multiplication_error", "חזקות", "כפל הבסיס במעריך במקום חישוב חזקה", "power_"],
  ["M-24", "zero_one_properties", "math_identity_property_error", "תכונות אפס ואחד", "שימוש לא נכון בתכונות של 0 או 1", "zero_"],
  ["M-25", "estimation", "math_estimation_strategy_error", "אומדן", "בלבול בין אומדן לתוצאה מדויקת", "est_"],
  ["M-26", "factors_multiples", "math_gcd_smaller_input_error", "גורמים וכפולות", "בחירה שגויה של המחלק המשותף הגדול ביותר", "fm_"],
];
