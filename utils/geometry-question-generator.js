  ...
  switch (selectedTopic) {
    ...
    case "triangles": {
      ...
      if (formulaBand === "mid") {
        ...
        // Late band (G5-G6) - expanded to 12 variants for better coverage
        const triLateW = Math.floor(Math.random() * 12);
        question =
          levelKey === "easy"
            ? [
    ...
    case "symmetry": {
      ...
      const symW = Math.floor(Math.random() * (formulaBand === "mid" ? 8 : 12));
