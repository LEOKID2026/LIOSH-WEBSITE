...
export function disclaimerQuoteBlock() {
  return {
    ...
    paragraphs: [
      ...
      "הם נועדו לשמש כלי עזר לימודי להורה ולילד/ה, ואינם מהווים אבחון חינוכי, דידקטי או מקצועי, ואינם מחליפים שיקול דעת של מורה, יועץ, איש חינוך או בעל מקצוע מוסמך.",
