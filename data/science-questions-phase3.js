...
export const SCIENCE_QUESTIONS_PHASE3 = [
  ...
  },
  {
    ...
    "maxLevel": "hard",
    "type": "true_false",
    "stem": "אם במעגן נמל קטן הניקוז מהעיר נפתח בזמן סערה, בהכרח איכות המים במפרץ תשתפר מיד בלי צורך במדידות נוספות.",
    "options": [
      "נכון",
      "לא נכון"
    ],
  ...
  },
  {
    ...
    "options": [
      "המדגם עלול להיות לא מייצג (הטיית מיקום) ולכן לא להכליל לכל האוכלוסייה",
      "סקר תמיד משקף את כולם בלי קשר למי נשאל",
      "שעות הערב מבטלות כל הטיה אוטומטית",
      "מתחם קניות מתאר רק אנשים בלי מכוניות"
    ],
    "correctIndex": 0,
  ...
  },
  {
    ...
    "options": [
      "כי עם n קטן תוצאות קיצוניות (0/3 או 3/3) קורות לעיתים גם בלי שינוי אמיתי בשיעור הנביטה",
      "כי שלושה זרעים תמיד מייצגים בדיוק את כל העולם",
      "כי זרעים לא נובטים לפי הסתברות",
      "כי 50% אומר שאין צורך בדוגמה בכלל"
    ],
    "correctIndex": 0,
  ...
  },
  {
    ...
    "options": [
      "ייתכן גורם משותף (קיץ חם) מקשר את שני הנתונים; לא בהכרח שגלידה גורמת לטביעות",
      "גלידה תמיד גורמת ישירות לטביעות",
      "טביעות גורמות לילדים לקנות גלידה",
      "אין צורך לבדוק גורמים אחרים כשהגרף עולה יחד"
    ],
    "correctIndex": 0,
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "כשהמודד 'עיוור' לתנאי (בלינד), פחות סיכוי שהפרשנות תהיה מושפעת מדעה מוקדמת. זה כלי מתודולוגי בסיסי במחקרי חושים.",
    "theoryLines": [
  ...
  },
  {
    ...
    "options": [
      "כדי לשמור ראיה לפרשנות מאוחרת ולא לאבד מידע (צבע, ריח, משך) שאולי חשוב אחרי דיון",
      "כי מסקנה חייבת להיכתב לפני הנתונים",
      "כי תצפית גולמית בלתי חוקית",
      "כי רק גרפים סופיים חשובים"
    ],
    "correctIndex": 0,
  ...
  },
  {
    ...
    "options": [
      "אנרגיה משוחררת כשלוחות נתקעות ומשחררות בהחלקה — זה יוצר גלים סייסמיים",
      "רעידות נגרמות רק כשירד גשם חזק ללא קשר לקרום",
      "לוחות תמיד נייחים ולכן אין רעידות מלוחות",
      "רעידות מצביעות תמיד על התפרצות געשית באותו מקום ובאותה שנייה"
    ],
    "correctIndex": 0,
  ...
  },
  {
    ...
    "correctIndex": 0,
    "explanation": "אלבדו (החזר) משפיע על כמה אנרגיה נבלעת; שינוי מקרח למים משנה מאזן אנרגיה מקומי ויכול לתמוך במשובים.",
    "theoryLines": [
  ...
  },
  {
    ...
    "options": [
      "זוויות שמש ומחזורי עונות שונים, תבליטי אוקיינוס וקרח, וזרימות גלובליות יוצרים שוני במים ובחום מועבר",
      "כי קטבים מקבלים תמיד יותר קרינה מקו המשווה",
      "כי אין הבדל בין רוחב גאוגרפי לאקלים",
      "כי הכבידה בקטבים מבטלת לחות לגמרי"
    ],
    "correctIndex": 0,
