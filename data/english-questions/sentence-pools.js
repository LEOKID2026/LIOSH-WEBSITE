...
export const SENTENCE_POOLS = {
  ...
  "advanced": [
    ...
    {
      "template": "If I ___ a million dollars, I would travel the world",
      "options": ["had", "have", "will have"],
      "correct": "had",
      "explanation": "Second conditional (תרחיש דמיוני) → If I had...",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_second_conditional_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "tense_error", "careless_error"],
      "skillId": "advanced_second_conditional_g6",
      "subtype": "advanced"
    },
    {
      "template": "She said that she ___ finished the book",
      "options": ["had", "has", "have"],
      "correct": "had",
      "explanation": "Reported speech — past perfect: She said that she had finished.",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_reported_speech_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "tense_error", "careless_error"],
      "skillId": "advanced_reported_speech_g6",
      "subtype": "advanced"
    },
    {
      "template": "The cake ___ eaten by the children",
      "options": ["was", "were", "is being"],
      "correct": "was",
      "explanation": "Passive voice — past: The cake was eaten.",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_passive_past_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "passive_error", "careless_error"],
      "skillId": "advanced_passive_past_g6",
      "subtype": "advanced"
    },
    {
      "template": "By the time she arrived, the show ___ started",
      "options": ["had already", "has already", "already"],
      "correct": "had already",
      "explanation": "Past perfect — פעולה שהושלמה לפני אחרת בעבר.",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_past_perfect_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "tense_error", "careless_error"],
      "skillId": "advanced_past_perfect_g6",
      "subtype": "advanced"
    },
    {
      "template": "You ___ exercise regularly to stay healthy",
      "options": ["should", "would", "could have"],
      "correct": "should",
      "explanation": "Modal — המלצה: should.",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_modal_should_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "modal_error", "careless_error"],
      "skillId": "advanced_modal_should_g6",
      "subtype": "advanced"
    },
    {
      "template": "The new library is ___ than the old one",
      "options": ["larger", "more large", "largest"],
      "correct": "larger",
      "explanation": "Comparative adjective — larger (לא more large).",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_comparative_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "comparatives_error", "careless_error"],
      "skillId": "advanced_comparative_g6",
      "subtype": "advanced"
    },
    {
      "template": "He told me that he ___ come to the party",
      "options": ["would", "will", "shall"],
      "correct": "would",
      "explanation": "Reported speech — will הופך ל-would.",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_reported_speech_would_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "tense_error", "careless_error"],
      "skillId": "advanced_reported_speech_would_g6",
      "subtype": "advanced"
    },
    {
      "template": "The letter ___ sent to all students yesterday",
      "options": ["was", "were", "is"],
      "correct": "was",
      "explanation": "Passive voice עבר — The letter was sent.",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_passive_letter_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "passive_error", "careless_error"],
      "skillId": "advanced_passive_letter_g6",
      "subtype": "advanced"
    },
    {
      "template": "If she ___ harder, she would have passed",
      "options": ["had studied", "studied", "would study"],
      "correct": "had studied",
      "explanation": "Third conditional — If she had studied (עבר השלמה), she would have passed.",
      "minGrade": 6,
      "maxGrade": 6,
    ...
    {
      "template": "You must not ___ in the library",
      "options": ["talk loudly", "talked loudly", "to talk loudly"],
      "correct": "talk loudly",
      "explanation": "Must not + base verb (ללא to).",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_modal_mustnot_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "modal_error", "careless_error"],
      "skillId": "advanced_modal_mustnot_g6",
      "subtype": "advanced"
    },
    {
      "template": "This is the ___ film I have ever seen",
      "options": ["most interesting", "more interesting", "interestingest"],
      "correct": "most interesting",
      "explanation": "Superlative — most interesting (מילה ארוכה).",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_superlative_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "comparatives_error", "careless_error"],
      "skillId": "advanced_superlative_g6",
      "subtype": "advanced"
    },
    {
      "template": "The windows ___ cleaned every week",
      "options": ["are", "were", "was"],
      "correct": "are",
      "explanation": "Passive voice הווה — The windows are cleaned.",
      "minGrade": 6,
      "maxGrade": 6,
      "patternFamily": "advanced_passive_present_g6",
      "difficulty": "advanced",
      "cognitiveLevel": "analysis",
      "expectedErrorTypes": ["grammar_error", "passive_error", "careless_error"],
      "skillId": "advanced_passive_present_g6",
      "subtype": "advanced"
    },
    {
      "template": "She asked whether I ___ join the team",
      "options": ["could", "can", "will"],
      "correct": "could",
      "explanation": "Indirect question — can הופך ל-could בהקשר עבר.",
      "minGrade": 6,
      "maxGrade": 6,
