...
const G1_WORDS = [
  ...
  { word: "כלב", first: "כ", last: "ב", syllables: 1, startSound: "כ" },
  { word: "שמש", first: "ש", last: "ש", repeat: "ש", syllables: 1, startSound: "ש" },
  { word: "אמא", first: "א", last: "א", repeat: "א", syllables: 2, startSound: "א" },
  { word: "אבא", first: "א", last: "א", repeat: "א", syllables: 2, startSound: "א" },
  { word: "ילד", first: "י", last: "ד", syllables: 1, startSound: "י" },
  { word: "ספר", first: "ס", last: "ר", syllables: 1, startSound: "ס" },
  { word: "תפוח", first: "ת", last: "ח", syllables: 2, startSound: "ת" },
  { word: "כיסא", first: "כ", last: "א", syllables: 2, startSound: "כ" },
  { word: "מים", first: "מ", last: "ם", repeat: "מ", syllables: 1, startSound: "מ" },
  { word: "שולחן", first: "ש", last: "ן", syllables: 2, startSound: "ש" },
  { word: "עץ", first: "ע", last: "ץ", syllables: 1, startSound: "ע" },
  { word: "יונה", first: "י", last: "ה", syllables: 2, startSound: "י" },
  { word: "כתב", first: "כ", last: "ב", syllables: 1, startSound: "כ" },
  { word: "גן", first: "ג", last: "ן", syllables: 1, startSound: "ג" },
  { word: "דג", first: "ד", last: "ג", syllables: 1, startSound: "ד" },
  { word: "ארנב", first: "א", last: "ב", syllables: 2, startSound: "א" },
  { word: "פרח", first: "פ", last: "ח", syllables: 1, startSound: "פ" },
  { word: "שלום", first: "ש", last: "ם", syllables: 2, startSound: "ש" },
  { word: "כדור", first: "כ", last: "ר", syllables: 2, startSound: "כ" },
  { word: "ענן", first: "ע", last: "ן", syllables: 2, startSound: "ע" },
  { word: "חתול", first: "ח", last: "ל", syllables: 2, startSound: "ח" },
  { word: "פרה", first: "פ", last: "ה", syllables: 1, startSound: "פ" },
  { word: "עפר", first: "ע", last: "ר", syllables: 1, startSound: "ע" },
  { word: "נר", first: "נ", last: "ר", syllables: 1, startSound: "נ" },
  { word: "יד", first: "י", last: "ד", syllables: 1, startSound: "י" },
  { word: "רגל", first: "ר", last: "ל", syllables: 1, startSound: "ר" },
  { word: "פה", first: "פ", last: "ה", syllables: 1, startSound: "פ" },
  { word: "אוזן", first: "א", last: "ן", syllables: 2, startSound: "א" },
  { word: "עין", first: "ע", last: "ן", syllables: 1, startSound: "ע" },
