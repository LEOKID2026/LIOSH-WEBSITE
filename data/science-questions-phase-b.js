...
export const SCIENCE_QUESTIONS_PHASE_B = [
  {
    ...
    "correctIndex": 0,
    "explanation": "משטח חלק מרגישים בלי בליטות.",
    "params": {
  ...
  },
  {
    ...
    "maxLevel": "medium",
    "type": "mcq",
    "stem": "איזה חומר יכול להיות קר במגע?",
    "options": [
      "קרח",
      "כוס תה חמה",
      "אבן חמה",
    ...
    "correctIndex": 0,
    "explanation": "קרח קר כי טמפרטורתו נמוכה.",
    "params": {
  ...
  },
  {
    ...
    "options": [
      "פוגע בבריאות ובמערכות אקולוגיות",
      "מחזק דגים",
      "מייצר חמצן",
      "אין השפעה"
    ],
