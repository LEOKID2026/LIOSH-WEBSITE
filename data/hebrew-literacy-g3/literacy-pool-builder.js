...
const G3_COMP_COMPARE = [
  ...
  },
  {
    ...
    wrong: ["אין שום הבדל", "שניהם שירים בלבד", "אין עלילה בשניהם"],
  },
  {
...
const G3_READ_PASSAGES_MEDIUM = [
  ...
  },
  {
    ...
    wrong: ["אין הבדל", "שניהם שירים בלבד", "במידע חייבת עלילה"],
  },
  {
...
const G3_READ_PASSAGES_HARD = [
  ...
  },
  {
    ...
    wrong: ["אין הבדל", "שניהם שירים בלבד", "מידע תמיד בלי מילים"],
  },
  {
