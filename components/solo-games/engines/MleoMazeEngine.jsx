                  ...
                  {maze.map((row, r) =>
                    row.map((cell, c) => {
                      ...
                      return (
                        ...
                        >
                          {isWall ? (
                            <span className="text-sm opacity-70 sm:text-base" aria-hidden>
                              🌿
                            </span>
                          ) : null}
                          {isPlayer ? (
                          ...
                          !isBonusDiamond(r, c) &&
                          onPath ? (
                            <span className="pointer-events-none absolute inset-0.5 rounded border border-dashed border-amber-100/10" />
                          ) : null}
                        </div>
                      );
                    })
