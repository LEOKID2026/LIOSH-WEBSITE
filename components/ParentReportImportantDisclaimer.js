    ...
    >
      ...
      <div className="parent-report-important-disclaimer-body space-y-2 text-[0.8125rem] md:text-sm leading-relaxed text-white/76">
        ...
        <p className="m-0">
          ...
          {" "}להורה ולילד/ה, ואינם מהווים הערכה חינוכית, דידקטית או מקצועית, ואינם מחליפים שיקול דעת של מורה, יועץ, איש חינוך או בעל מקצוע מוסמך.
        </p>
        <p className="m-0">
          במקרה של אתגר לימודי מתמשך, פער לימודי משמעותי או צורך בהכוונה אישית, מומלץ להיוועץ במורה או באיש מקצוע מתאים.
        </p>
      </div>
    </aside>
  );
