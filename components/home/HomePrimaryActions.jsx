...
export default function HomePrimaryActions({ isBright }) {
  ...
  const parentBtn = `${getHomeBtnClasses("parents", isBright, "primary")} min-h-12 px-8 text-base md:min-h-[3.25rem] md:text-lg`;
  const kidsBtn = `${getHomeBtnClasses("kids", isBright, "secondary")} min-h-12 px-8 text-base md:min-h-[3.25rem] md:text-lg`;
  ...
  return (
    ...
    >
      <div className="flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-center lg:gap-4">
        <HomeCtaLink
