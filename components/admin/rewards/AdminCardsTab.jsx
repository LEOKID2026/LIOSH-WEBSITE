...
function CardForm({
  ...
  return (
    <div className="mt-4 rounded-xl border border-white/10 bg-white/[0.03] p-4 space-y-3">
      ...
      {showGrant ? (
        <div className="flex flex-wrap gap-2 items-end border-t border-white/10 pt-3">
      ...
      <div className="flex gap-2 justify-end">
        <button type="button" onClick={onCancel} className="rounded border border-white/15 px-3 py-1 text-xs">
          ביטול
        </button>
        <button
          type="button"
