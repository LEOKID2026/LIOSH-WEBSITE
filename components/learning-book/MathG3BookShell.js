...
import {
  ...
  handleMathG3BookClose,
  isMathG3BookLearningReturn,
...
export default function MathG3BookShell({
  children,
  batches,
  activePageId = null,
  pageMeta = null,
          ...
          <div className="mx-auto max-w-4xl space-y-2 px-4 py-3 sm:py-3.5">
            {!isIndex ? (
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="text-xs text-[color:var(--book-text-muted)]">{MATH_G3_BOOK_META.gradeShortLabel}</div>
              </div>
            )}
