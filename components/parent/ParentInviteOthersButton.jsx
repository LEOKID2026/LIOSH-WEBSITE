...
/** Share invite for parent dashboard — copy message + centered popup confirmation. */
export default function ParentInviteOthersButton({ bright = false }) {
