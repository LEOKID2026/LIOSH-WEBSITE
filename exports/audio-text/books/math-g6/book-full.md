...
חשבו 48,750 + 25,680 = ?
אחדות 0, עשרות 13→3+נשיאה, מאות 14→4+נשיאה.
אלפים 12→2+נשיאה, עשרות אלפים 7+1=8.
74,430
...
חשבו: 73,400 − 29,365
אחדות: 0<5 → שואלים. 10−5=5.
עשרות: 9 (אחרי השאלה מהמאות) → 9<6? לא, 9>6. עשרות אחרי שאלה: נשאר 3 → 3<6 → שואלים. 13−6=7. נשאר 2 עשרות.
מאות: 3 (אחרי השאלה) − 3 = 0.
אלפים: 3<9 → שואלים. 13−9=4.
עשרות אלפים: 6 (אחרי השאלה) → 6−2=4.
