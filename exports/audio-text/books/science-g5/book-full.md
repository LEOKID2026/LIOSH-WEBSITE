...
שרירים בזרוע מושכים ודוחפים את העצמות.
לייצר את התנועה
...
משתנה — צורה, גודל והתנהגות בכל שלב. נשאר — המין (פרפר) ותכונות מורשות כמו צבע כנף. ✓
...
זהו החזר.
זכוכית שקופה — מאפשרת לאור לעבור דרכה כמעט ללא עיכוב.
זו שקיפות.
לכן:
...
האם צמח עם יותר מים גבוה יותר אחרי שבוע?
יומן:
כל יום — גובה בס"מ.
גרף:
...
מספר הניסוי, כמה מ"ל מים שאב כל ספוג, הערות.
...
יומן — תאריך וכמות מים בכל מדידה. גרף — ציר אופקי (ניסויים), ציר אנכי (מ"ל מים), נקודות. ✓
