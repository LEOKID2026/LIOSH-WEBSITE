...
איך אומרים "הלווייתנים שחו כשראינו אותם"?
The whales were swimming when we saw them
...
איך אומרים "הקהילה שלנו חגגה את הפסטיבל בחודש שעבר"?
Our community celebrated the festival last month
...
תרגיל: "ילדים ומבוגרים רקדו יחד בפסטיבל."
פועל סדיר בעבר: dance הופך ל-danced.
together = יחד; at the festival = בפסטיבל.
ילדים ומבוגרים רקדו יחד בפסטיבל.
Children and adults danced together at the festival.
...
איך אומרים "אולי הוא ירגיש לחוץ לפני ההצגה"?
He might feel nervous before the presentation
...
איך אומרים "שינוי האקלים משפיע על אנשים ברחבי העולם"?
Climate change affects people around the world
...
איך אומרים "כדאי לשתות מים ולנוח כשאתם עייפים"?
You should drink water and rest when you are tired
...
If the internet stops working, we could use books instead — אם האינטרנט מפסיק לעבוד, נוכל להשתמש בספרים במקום.

## Chapter 037 — עמוד 37

If + Present, could — אפשרות:
If the internet stops working, we could use books instead.
אם האינטרנט מפסיק לעבוד, נוכל להשתמש בספרים במקום.
If the computer breaks, we could write by hand.
אם המחשב מתקלקל, נוכל לכתוב ביד.
...
איך אומרים "אם האינטרנט מפסיק לעבוד, נוכל להשתמש בספרים במקום"?
If the internet stops working, we could use books instead

## Chapter 040 — עמוד 40

חשמל כבוי — מה עושים?
If the electricity goes off, we could use flashlights.
נסו לפתור בעצמכם.
בעמוד הבא נבדוק יחד את הדרך ואת התשובה.

## Chapter 041 — עמוד 41

תרגיל: "אם החשמל נכבה, נוכל להשתמש בפנסים."
If + Present Simple, could + פועל = אפשרות.
goes off = נכבה; could use = נוכל להשתמש.
אם החשמל נכבה, נוכל להשתמש בפנסים.
If the electricity goes off, we could use flashlights.

## Chapter 042 — עמוד 42

עכשיו אתם מדברים על טכנולוגיה בתנאי.
בתרגול תמצאו If the internet stops working, we could use books instead.
...
איך אומרים "ביקרנו בשלוש מדינות עד כה"?
We have visited three countries so far
...
איך אומרים "מוזיקה היא חלק חשוב מהתרבות שלנו"?
Music is an important part of our culture
...
איך אומרים "מדינות רבות עובדות יחד על סוגיות גלובליות"?
Many countries work together on global issues
...
איך אומרים "למדנו על היסטוריה עתיקה בכיתה"?
We learned about ancient history in class
...
איך אומרים "אם ירד גשם, נישאר בבית"?
If it rains, we will stay at home

## Chapter 082 — עמוד 82

תכנון שיעורי בית — ציון טוב מחכה.
...
תרגיל: "אם תכין שיעורי בית, תקבל ציון טוב."
Type 1: If + Present Simple, will + פועל.
do your homework = תכין שיעורי בית; will get = תקבל.
אם תכין שיעורי בית, תקבל ציון טוב.
If you do your homework, you will get a good grade.
...
היום נלמד should, might, could — מילים שעוזרות לתת עצה, אפשרות או רעיון.
...
איך אומרים "כדאי לשאול את המורה לעזרה"?
You should ask the teacher for help
...
איך אומרים "זה הספר המעניין ביותר שקראתי"?
This is the most interesting book I have read
...
funny מסתיימת ב-y. בצורה funniest מחליפים את y ב-i ומוסיפים est.
...
איך אומרים "בזמן שלמדתי, אחותי האזינה למוזיקה"?
While I was studying, my sister was listening to music
...
איך אומרים "מדענים אולי יגלו דרכים חדשות לחסוך אנרגיה"?
Scientists might discover new ways to save energy
...
If we protect the oceans, future generations will benefit — אם נגן על האוקיינוסים, דורות עתידיים יפיקו מכך תועלת.

## Chapter 114 — עמוד 114

If + Present, will — תוצאה בעתיד:
If we protect the oceans, future generations will benefit.
אם נגן על האוקיינוסים, דורות עתידיים יפיקו מכך תועלת.
...
איך אומרים "אם נגן על האוקיינוסים, דורות עתידיים יפיקו מכך תועלת"?
If we protect the oceans, future generations will benefit
...
תרגיל: "אם נגן על היערות, בעלי החיים ישרדו."
Type 1: If + Present Simple, will + פועל.
protect = נגן; will survive = ישרדו.
אם נגן על היערות, בעלי החיים ישרדו.
If we protect the forests, animals will survive.
