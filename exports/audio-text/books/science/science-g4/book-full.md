...
בפה — לעיסה ורוק. אחרי בליעה — לוע, קיבה, מעיים. ✓
...
מבודד הוא חומר שמונע מהחשמל לעבור — כמו גומי, פלסטיק, צמר, עץ.
...
שיטה:
מודדים כמה מ"ל מים שאב כל ספוג — ומשווים.
מסקנה:
אם הספוג הגדול ספג יותר — ההשערה נכונה.
