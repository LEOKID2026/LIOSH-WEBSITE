...
בבית: איזה משאב מתחדש אתם משתמשים בו?
(מים, שמש)
...
מים — מתחדשים במחזור הטבע: אידוי, עננים, גשם, נהרות.
שמש — מקור אנרגיה שחוזר כל יום; פאנלים סולריים ממירים אותה לחשמל.
זיהום קיים בכל הסביבות: עשן ממכוניות — אוויר; פסולת לנחל — מים; שקיות פלסטיק שנשארות בקרקע — קרקע.

**תשובה:** משאב מתחדש בבית — מים, שמש. זיהום — אוויר (עשן), מים (פסולת), קרקע (פלסטיק). ✓
