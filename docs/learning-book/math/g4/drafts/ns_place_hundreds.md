...
במספר 6,729 — כמה אלפים יש? (מה ערך ספרת האלפים?)
...
**שלב 1:** מזהים ספרות: 6 | 7 | 2 | 9 (אלפים | מאות | עשרות | אחדות).

**שלב 2:** ספרת האלפים היא **6**.

**שלב 3:** 6 במקום אלפים = **6,000**.

**תשובה: ערך ספרת האלפים ב-6,729 הוא 6,000** ✓
