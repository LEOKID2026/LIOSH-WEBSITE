...
**שלב 1:** שימו אצבע על 8 בציר המספרים.

**שלב 2:** קפצו צעד אחד ימינה → 9.

**שלב 3:** עוד צעד ימינה → 10.

**תשובה: שני המספרים הבאים הם 9, 10.** ✓
...
בתרגול תמצאו שאלות שבהן צריך להמשיך סדרה של מספרים. זכרו: בכל פעם מתקדמים צעד אחד ימינה.
