...
**שלב 1:** במלבן יש **זוויות ישרות** — לכן √(a²+b²) עובד.

**שלב 2:** במקבילית כללית — הזווית בין הצלעות **אינה** בהכרח 90°.

**שלב 3:** ללא זווית ישרה — לא ניתן להשתמש בנוסחת מלבן.

**תשובה: לא** — במקבילית כללית צריך נתון נוסף (זווית או גובה). ✓
