...
**שלב 1:** בודקים קיפול דרך אמצע הצלעות — אופקי ואנכי. שני קיפולים עובדים.

**שלב 2:** בודקים קיפול באלכסון — במלבן שאינו ריבוע הצלעות אינן שוות, ולכן הקיפול האלכסוני אינו יוצר שני חצאים זהים.

**תשובה: 2 צירי סימטרייה** ✓
