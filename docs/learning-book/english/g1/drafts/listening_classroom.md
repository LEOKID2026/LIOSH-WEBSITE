...
שאלה: מה עושים כששומעים "Open your book"?

שלב 1: Open פירושו לפתוח.

שלב 2: Book פירושו ספר.

שלב 3: פותחים את הספר.

תשובה: פותחים את הספר
...
שלב 1: Close פירושו לסגור.

שלב 2: Book פירושו ספר.

שלב 3: סוגרים את הספר.
