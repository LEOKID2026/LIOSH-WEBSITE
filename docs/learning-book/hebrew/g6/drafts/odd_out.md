...
נחזור לשאלה: איזו מילה שונה?

שלב 1: ניתוח, השוואה, סיכום — כולן מונחי עבודה ולמידה.

שלב 2: כדורגל — ספורט, לא מונח לימוד.

שלב 3: הקטגוריה המשותפת לשלוש — מונחי למידה ועבודה.

✓ תשובה: כדורגל היא המילה השונה — שאר המילים הן מונחי למידה; כדורגל שייך לספורט.
