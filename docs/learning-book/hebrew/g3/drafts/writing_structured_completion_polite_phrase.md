...
שאלת סעיף 5: מה מתאים — תודה או בבקשה?

שלב 1: כבר אמרו תודה על העזרה הקודמת.

שלב 2: עכשיו מבקשים שוב — לפני בקשה: בבקשה.

שלב 3: תודה — אחרי קבלת עזרה, לא לפניה.

**תשובה: בבקשה — לפני הבקשה הבאה. ✓**
