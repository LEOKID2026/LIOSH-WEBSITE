...
שאלת סעיף 5: מה ההפך של שקט בים?

שלב 1: שקט — מצב של רגיעה ללא תנועה חזקה.

שלב 2: סערה — מים סוערים, ההפך מרגיעה.

שלב 3: נוח ורגוע — קרובים לשקט, לא הפוכים.

**תשובה: סוער — ההפך של שקט בים. ✓**
