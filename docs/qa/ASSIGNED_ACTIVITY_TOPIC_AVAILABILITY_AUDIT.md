...
Generated: 2026-06-03T15:25:31.159Z
...
| geometry | g3 | parallel_perpendicular | מקבילות ומאונכות | yes | diagram/rendering-gap | supported | supported (book pages) — page: parallel_perpendicular | geometry-question-generator (dynamic; diagram spec required for activities) | generator produces kinds [parallel_perpendicular, concept_lines] but 0/120 get diagram spec; assigned activities require diagrams | must-have core topic | support diagrams/rendering |
...
| geometry | g4 | parallel_perpendicular | מקבילות ומאונכות | yes | diagram/rendering-gap | supported | supported (book pages) — page: parallel_perpendicular | geometry-question-generator (dynamic; diagram spec required for activities) | generator produces kinds [concept_lines, parallel_perpendicular] but 0/120 get diagram spec; assigned activities require diagrams | must-have core topic | support diagrams/rendering |
...
| geometry | g4 | diagonal | אלכסון | yes | diagram/rendering-gap | supported | supported (book pages) — related pages: diagonal_square, diagonal_rectangle | geometry-question-generator (dynamic; diagram spec required for activities) | generator produces kinds [diagonal_rectangle, diagonal_square] but 0/120 get diagram spec; assigned activities require diagrams | must-have core topic | support diagrams/rendering |
| geometry | g4 | symmetry | סימטרייה | yes | diagram/rendering-gap | supported | supported (book pages) — page: symmetry | geometry-question-generator (dynamic; diagram spec required for activities) | generator produces kinds [concept_symmetry, symmetry] but 0/120 get diagram spec; assigned activities require diagrams | must-have core topic | support diagrams/rendering |
...
| geometry | g5 | parallel_perpendicular | מקבילות ומאונכות | yes | diagram/rendering-gap | supported | supported (book pages) — page: parallel_perpendicular | geometry-question-generator (dynamic; diagram spec required for activities) | generator produces kinds [concept_lines, parallel_perpendicular] but 0/120 get diagram spec; assigned activities require diagrams | must-have core topic | support diagrams/rendering |
...
| geometry | g5 | diagonal | אלכסון | yes | diagram/rendering-gap | supported | supported (book pages) — related pages: diagonal_square, diagonal_rectangle, diagonal_parallelogram | geometry-question-generator (dynamic; diagram spec required for activities) | generator produces kinds [diagonal_rectangle, diagonal_square, diagonal_parallelogram] but 0/120 get diagram spec; assigned activities require diagrams | must-have core topic | support diagrams/rendering |
| geometry | g5 | heights | גבהים | yes | diagram/rendering-gap | supported | supported (book pages) — related pages: heights_triangle, heights_parallelogram, heights_trapezoid | geometry-question-generator (dynamic; diagram spec required for activities) | generator produces kinds [heights_trapezoid, heights_triangle, heights_parallelogram] but 0/120 get diagram spec; assigned activities require diagrams | must-have core topic | support diagrams/rendering |
| geometry | g5 | tiling | ריצוף | yes | diagram/rendering-gap | supported | supported (book pages) — page: tiling | geometry-question-generator (dynamic; diagram spec required for activities) | generator produces kinds [concept_tiling, tiling] but 0/120 get diagram spec; assigned activities require diagrams | nice-to-have | support diagrams/rendering |
...
| geometry | g6 | volume | נפח | yes | thin-bank | supported | supported (book pages) — related pages: rectangular_prism_volume, prism_volume_rectangular, prism_volume_triangle, pyramid_volume_square, pyramid_volume_rectangular, cylinder_volume, cone_volume, sphere_volume | geometry-question-generator (dynamic; diagram spec required for activities) | passes @ count=3 but fails @ count=5 at: medium | must-have core topic | add/expand question bank |
...
| hebrew | g2 | reading | קריאה | yes | supported | supported | explanation-only-or-absent — topic not in book TOC | hebrew-question-generator (dynamic) |  | must-have core topic | keep visible |
...
| english | g2 | translation | תרגום | yes | difficulty-filter-gap | supported | supported (book pages) — related pages: translation_classroom, translation_routines | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: hard. Bank counts:  | must-have core topic | add/expand question bank |
...
| english | g3 | grammar | דקדוק | yes | difficulty-filter-gap | supported | supported (book pages) — related pages: grammar_present_simple, grammar_articles_prepositions, grammar_question_frames | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: hard. Bank counts:  | must-have core topic | add/expand question bank |
| english | g3 | translation | תרגום | yes | thin-bank | supported | supported (book pages) — related pages: translation_routines, translation_hobbies | english-questions pools + generator (grammar/sentences/translation/vocabulary) | partial pass; typical fails at easy, medium, hard | must-have core topic | add/expand question bank |
| english | g3 | sentences | משפטים | yes | difficulty-filter-gap | supported | explanation-only-or-absent — topic not in book TOC | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  | must-have core topic | add/expand question bank |
...
| english | g4 | grammar | דקדוק | yes | difficulty-filter-gap | supported | supported (book pages) — related pages: grammar_present_simple, grammar_simple_continuous, grammar_quantifiers | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  | must-have core topic | add/expand question bank |
| english | g4 | translation | תרגום | yes | thin-bank | supported | supported (book pages) — related pages: translation_hobbies, translation_community | english-questions pools + generator (grammar/sentences/translation/vocabulary) | partial pass; typical fails at easy, medium, hard | must-have core topic | add/expand question bank |
| english | g4 | sentences | משפטים | yes | difficulty-filter-gap | supported | explanation-only-or-absent — topic not in book TOC | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  | must-have core topic | add/expand question bank |
...
| english | g5 | grammar | דקדוק | yes | difficulty-filter-gap | supported | supported (book pages) — related pages: grammar_past_simple, grammar_future_forms, grammar_modals, grammar_comparatives, grammar_quantifiers | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  | must-have core topic | add/expand question bank |
| english | g5 | translation | תרגום | yes | thin-bank | supported | supported (book pages) — related pages: translation_community, translation_technology, translation_global | english-questions pools + generator (grammar/sentences/translation/vocabulary) | partial pass; typical fails at easy, medium, hard | must-have core topic | add/expand question bank |
| english | g5 | sentences | משפטים | yes | difficulty-filter-gap | supported | explanation-only-or-absent — topic not in book TOC | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  | must-have core topic | add/expand question bank |
...
| english | g6 | grammar | דקדוק | yes | difficulty-filter-gap | supported | supported (book pages) — related pages: grammar_complex_tenses, grammar_conditionals, grammar_modals, grammar_comparatives | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  | must-have core topic | add/expand question bank |
| english | g6 | translation | תרגום | yes | unsupported-generator | partial | supported (book pages) — related pages: translation_technology, translation_global | english-questions pools + generator (grammar/sentences/translation/vocabulary) | אין מספיק שאלות אנגלית עבור כיתה ו׳ — נושא: תרגום — רמה: קל | must-have core topic | fix generator/mapping |
| english | g6 | sentences | משפטים | yes | difficulty-filter-gap | supported | explanation-only-or-absent — topic not in book TOC | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  | must-have core topic | add/expand question bank |
...
| science | g1 | materials | חומרים | yes | difficulty-filter-gap | supported | supported (book pages) — page: materials | static SCIENCE_QUESTIONS ({"easy":11,"medium":1,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":11,"medium":1,"hard":1} | must-have core topic | add/expand question bank |
| science | g1 | earth_space | כדור הארץ וחלל | yes | difficulty-filter-gap | supported | supported (book pages) — page: earth_space | static SCIENCE_QUESTIONS ({"easy":10,"medium":1,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":10,"medium":1,"hard":1} | must-have core topic | add/expand question bank |
| science | g1 | environment | סביבה | yes | difficulty-filter-gap | supported | supported (book pages) — page: environment | static SCIENCE_QUESTIONS ({"easy":9,"medium":1,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":9,"medium":1,"hard":1} | must-have core topic | add/expand question bank |
...
| science | g2 | materials | חומרים | yes | difficulty-filter-gap | supported | supported (book pages) — page: materials | static SCIENCE_QUESTIONS ({"easy":12,"medium":6,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: hard. Bank counts: {"easy":12,"medium":6,"hard":1} | must-have core topic | add/expand question bank |
| science | g2 | earth_space | כדור הארץ וחלל | yes | difficulty-filter-gap | supported | supported (book pages) — page: earth_space | static SCIENCE_QUESTIONS ({"easy":8,"medium":3,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":8,"medium":3,"hard":1} | must-have core topic | add/expand question bank |
| science | g2 | environment | סביבה | yes | difficulty-filter-gap | supported | supported (book pages) — page: environment | static SCIENCE_QUESTIONS ({"easy":10,"medium":4,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":10,"medium":4,"hard":1} | must-have core topic | add/expand question bank |
...
| science | g3 | materials | חומרים | yes | thin-bank | supported | supported (book pages) — page: materials | static SCIENCE_QUESTIONS ({"easy":4,"medium":21,"hard":4} usable by level) | passes @ count=3 but fails @ count=5 at: easy, hard | must-have core topic | add/expand question bank |
| science | g3 | earth_space | כדור הארץ וחלל | yes | thin-bank | supported | supported (book pages) — page: earth_space | static SCIENCE_QUESTIONS ({"easy":4,"medium":18,"hard":4} usable by level) | passes @ count=3 but fails @ count=5 at: easy, hard | must-have core topic | add/expand question bank |
| science | g3 | environment | סביבה | yes | thin-bank | supported | supported (book pages) — page: environment | static SCIENCE_QUESTIONS ({"easy":4,"medium":17,"hard":4} usable by level) | passes @ count=3 but fails @ count=5 at: easy, hard | must-have core topic | add/expand question bank |
...
| science | g4 | materials | חומרים | yes | thin-bank | supported | supported (book pages) — page: materials | static SCIENCE_QUESTIONS ({"easy":4,"medium":21,"hard":5} usable by level) | passes @ count=3 but fails @ count=5 at: easy | must-have core topic | add/expand question bank |
| science | g4 | earth_space | כדור הארץ וחלל | yes | thin-bank | supported | supported (book pages) — page: earth_space | static SCIENCE_QUESTIONS ({"easy":4,"medium":15,"hard":10} usable by level) | passes @ count=3 but fails @ count=5 at: easy | must-have core topic | add/expand question bank |
| science | g4 | environment | סביבה | yes | thin-bank | supported | supported (book pages) — page: environment | static SCIENCE_QUESTIONS ({"easy":4,"medium":15,"hard":9} usable by level) | passes @ count=3 but fails @ count=5 at: easy | must-have core topic | add/expand question bank |
...
| science | g5 | materials | חומרים | yes | thin-bank | supported | supported (book pages) — page: materials | static SCIENCE_QUESTIONS ({"easy":2,"medium":3,"hard":7} usable by level) | partial pass; typical fails at easy, medium | must-have core topic | add/expand question bank |
| science | g5 | earth_space | כדור הארץ וחלל | yes | thin-bank | supported | supported (book pages) — page: earth_space | static SCIENCE_QUESTIONS ({"easy":3,"medium":11,"hard":18} usable by level) | passes @ count=3 but fails @ count=5 at: easy | must-have core topic | add/expand question bank |
| science | g5 | environment | סביבה | yes | thin-bank | supported | supported (book pages) — page: environment | static SCIENCE_QUESTIONS ({"easy":3,"medium":10,"hard":24} usable by level) | passes @ count=3 but fails @ count=5 at: easy | must-have core topic | add/expand question bank |
...
| science | g6 | materials | חומרים | yes | thin-bank | supported | supported (book pages) — page: materials | static SCIENCE_QUESTIONS ({"easy":2,"medium":3,"hard":13} usable by level) | partial pass; typical fails at easy, medium | must-have core topic | add/expand question bank |
| science | g6 | earth_space | כדור הארץ וחלל | yes | thin-bank | supported | supported (book pages) — page: earth_space | static SCIENCE_QUESTIONS ({"easy":3,"medium":18,"hard":17} usable by level) | passes @ count=3 but fails @ count=5 at: easy | must-have core topic | add/expand question bank |
| science | g6 | environment | סביבה | yes | thin-bank | supported | supported (book pages) — page: environment | static SCIENCE_QUESTIONS ({"easy":4,"medium":10,"hard":29} usable by level) | passes @ count=3 but fails @ count=5 at: easy | must-have core topic | add/expand question bank |
...
|---------|-------|-------|-----------------|------------------|-------------------|
| geometry | g3 | parallel_perpendicular | diagram/rendering-gap | must-have core topic; exists in learning (supported) | support diagrams/rendering |
| geometry | g4 | parallel_perpendicular | diagram/rendering-gap | must-have core topic; exists in learning (supported) | support diagrams/rendering |
| geometry | g4 | diagonal | diagram/rendering-gap | must-have core topic; exists in learning (supported) | support diagrams/rendering |
| geometry | g4 | symmetry | diagram/rendering-gap | must-have core topic; exists in learning (supported) | support diagrams/rendering |
| geometry | g5 | parallel_perpendicular | diagram/rendering-gap | must-have core topic; exists in learning (supported) | support diagrams/rendering |
| geometry | g5 | diagonal | diagram/rendering-gap | must-have core topic; exists in learning (supported) | support diagrams/rendering |
| geometry | g5 | heights | diagram/rendering-gap | must-have core topic; exists in learning (supported) | support diagrams/rendering |
| geometry | g6 | volume | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g2 | translation | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g3 | grammar | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g3 | translation | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g3 | sentences | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g4 | grammar | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g4 | translation | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g4 | sentences | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g5 | grammar | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g5 | translation | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g5 | sentences | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g6 | grammar | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| english | g6 | translation | unsupported-generator | must-have core topic; exists in learning (partial) | fix generator/mapping |
| english | g6 | sentences | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g1 | materials | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g1 | earth_space | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g1 | environment | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g2 | materials | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g2 | earth_space | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g2 | environment | difficulty-filter-gap | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g3 | materials | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g3 | earth_space | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g3 | environment | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g4 | materials | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g4 | earth_space | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g4 | environment | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g5 | materials | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g5 | earth_space | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g5 | environment | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g6 | materials | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g6 | earth_space | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
| science | g6 | environment | thin-bank | must-have core topic; exists in learning (supported) | add/expand question bank |
...
|---------|-------|-------|-------------|---------|
| geometry | g6 | volume | geometry-question-generator (dynamic; diagram spec required for activities) | passes @ count=3 but fails @ count=5 at: medium |
| english | g2 | translation | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: hard. Bank counts:  |
| english | g3 | grammar | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: hard. Bank counts:  |
| english | g3 | translation | english-questions pools + generator (grammar/sentences/translation/vocabulary) | partial pass; typical fails at easy, medium, hard |
| english | g3 | sentences | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  |
| english | g4 | grammar | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  |
| english | g4 | translation | english-questions pools + generator (grammar/sentences/translation/vocabulary) | partial pass; typical fails at easy, medium, hard |
| english | g4 | sentences | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  |
| english | g5 | grammar | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  |
| english | g5 | translation | english-questions pools + generator (grammar/sentences/translation/vocabulary) | partial pass; typical fails at easy, medium, hard |
| english | g5 | sentences | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  |
| english | g6 | grammar | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  |
| english | g6 | sentences | english-questions pools + generator (grammar/sentences/translation/vocabulary) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts:  |
| science | g1 | materials | static SCIENCE_QUESTIONS ({"easy":11,"medium":1,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":11,"medium":1,"hard":1} |
| science | g1 | earth_space | static SCIENCE_QUESTIONS ({"easy":10,"medium":1,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":10,"medium":1,"hard":1} |
| science | g1 | environment | static SCIENCE_QUESTIONS ({"easy":9,"medium":1,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":9,"medium":1,"hard":1} |
| science | g2 | materials | static SCIENCE_QUESTIONS ({"easy":12,"medium":6,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: hard. Bank counts: {"easy":12,"medium":6,"hard":1} |
| science | g2 | earth_space | static SCIENCE_QUESTIONS ({"easy":8,"medium":3,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":8,"medium":3,"hard":1} |
| science | g2 | environment | static SCIENCE_QUESTIONS ({"easy":10,"medium":4,"hard":1} usable by level) | easy OK @ count=5; fails medium/hard: medium, hard. Bank counts: {"easy":10,"medium":4,"hard":1} |
| science | g3 | materials | static SCIENCE_QUESTIONS ({"easy":4,"medium":21,"hard":4} usable by level) | passes @ count=3 but fails @ count=5 at: easy, hard |
| science | g3 | earth_space | static SCIENCE_QUESTIONS ({"easy":4,"medium":18,"hard":4} usable by level) | passes @ count=3 but fails @ count=5 at: easy, hard |
| science | g3 | environment | static SCIENCE_QUESTIONS ({"easy":4,"medium":17,"hard":4} usable by level) | passes @ count=3 but fails @ count=5 at: easy, hard |
| science | g4 | materials | static SCIENCE_QUESTIONS ({"easy":4,"medium":21,"hard":5} usable by level) | passes @ count=3 but fails @ count=5 at: easy |
| science | g4 | earth_space | static SCIENCE_QUESTIONS ({"easy":4,"medium":15,"hard":10} usable by level) | passes @ count=3 but fails @ count=5 at: easy |
| science | g4 | environment | static SCIENCE_QUESTIONS ({"easy":4,"medium":15,"hard":9} usable by level) | passes @ count=3 but fails @ count=5 at: easy |
| science | g5 | materials | static SCIENCE_QUESTIONS ({"easy":2,"medium":3,"hard":7} usable by level) | partial pass; typical fails at easy, medium |
| science | g5 | earth_space | static SCIENCE_QUESTIONS ({"easy":3,"medium":11,"hard":18} usable by level) | passes @ count=3 but fails @ count=5 at: easy |
| science | g5 | environment | static SCIENCE_QUESTIONS ({"easy":3,"medium":10,"hard":24} usable by level) | passes @ count=3 but fails @ count=5 at: easy |
| science | g6 | materials | static SCIENCE_QUESTIONS ({"easy":2,"medium":3,"hard":13} usable by level) | partial pass; typical fails at easy, medium |
| science | g6 | earth_space | static SCIENCE_QUESTIONS ({"easy":3,"medium":18,"hard":17} usable by level) | passes @ count=3 but fails @ count=5 at: easy |
| science | g6 | environment | static SCIENCE_QUESTIONS ({"easy":4,"medium":10,"hard":29} usable by level) | passes @ count=3 but fails @ count=5 at: easy |
...
|---------|-------|-------|------------|--------|----------------|
| geometry | g3 | parallel_perpendicular | diagram/rendering-gap | generator produces kinds [parallel_perpendicular, concept_lines] but 0/120 get diagram spec; assigned activities require diagrams | support diagrams/rendering |
| geometry | g4 | parallel_perpendicular | diagram/rendering-gap | generator produces kinds [concept_lines, parallel_perpendicular] but 0/120 get diagram spec; assigned activities require diagrams | support diagrams/rendering |
| geometry | g4 | diagonal | diagram/rendering-gap | generator produces kinds [diagonal_rectangle, diagonal_square] but 0/120 get diagram spec; assigned activities require diagrams | support diagrams/rendering |
| geometry | g4 | symmetry | diagram/rendering-gap | generator produces kinds [concept_symmetry, symmetry] but 0/120 get diagram spec; assigned activities require diagrams | support diagrams/rendering |
| geometry | g5 | parallel_perpendicular | diagram/rendering-gap | generator produces kinds [concept_lines, parallel_perpendicular] but 0/120 get diagram spec; assigned activities require diagrams | support diagrams/rendering |
| geometry | g5 | diagonal | diagram/rendering-gap | generator produces kinds [diagonal_rectangle, diagonal_square, diagonal_parallelogram] but 0/120 get diagram spec; assigned activities require diagrams | support diagrams/rendering |
| geometry | g5 | heights | diagram/rendering-gap | generator produces kinds [heights_trapezoid, heights_triangle, heights_parallelogram] but 0/120 get diagram spec; assigned activities require diagrams | support diagrams/rendering |
| geometry | g5 | tiling | diagram/rendering-gap | generator produces kinds [concept_tiling, tiling] but 0/120 get diagram spec; assigned activities require diagrams | support diagrams/rendering |
| english | g6 | translation | unsupported-generator | אין מספיק שאלות אנגלית עבור כיתה ו׳ — נושא: תרגום — רמה: קל | fix generator/mapping |
