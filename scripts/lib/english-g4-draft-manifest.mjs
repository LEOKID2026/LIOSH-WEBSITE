...
export const ENGLISH_G4_ALIGNMENT_ANCHORS = {
  vocab_animals: ["The birds are flying"],
  vocab_body: ["He washes his hands"],
  vocab_emotions: ["They feel excited"],
  vocab_family: ["My parents work hard"],
  vocab_food: ["We eat healthy food"],
  vocab_school: ["The students read books"],
  vocab_sports: ["She is swimming now"],
  vocab_weather: ["It is raining today"],
  vocab_community: ["The park is in our town"],
  vocab_environment: ["We protect the trees"],
  vocab_travel: ["We travel by bus"],
  grammar_present_simple: ["He walks to school"],
  grammar_simple_continuous: ["She is reading now"],
  grammar_quantifiers: ["I have some apples"],
  sentence_descriptive: ["The tall girl runs quickly"],
  sentence_routine: ["Every day I help at home"],
  sentence_narrative: ["First we pack our bags"],
  translation_hobbies: ["He is playing guitar"],
  translation_community: ["The library is near the school"],
};
