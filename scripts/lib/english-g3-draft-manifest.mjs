...
export const ENGLISH_G3_ALIGNMENT_ANCHORS = {
  vocab_actions: ["I play"],
  vocab_animals: ["The dog runs"],
  vocab_colors: ["The sky is blue"],
  vocab_emotions: ["She feels happy"],
  vocab_family: ["My brother reads"],
  vocab_food: ["I eat an apple"],
  vocab_house: ["The book is on the table"],
  vocab_numbers: ["There are ten books"],
  vocab_school: ["We learn English"],
  vocab_body: ["My head hurts"],
  vocab_sports: ["I play football"],
  vocab_weather: ["It is sunny"],
  grammar_present_simple: ["I play tennis"],
  grammar_articles_prepositions: ["The cat is under the bed"],
  grammar_question_frames: ["Do you like music?"],
  sentence_routine: ["I brush my teeth"],
  sentence_descriptive: ["The big dog runs fast"],
  translation_routines: ["I go to bed"],
  translation_hobbies: ["I like to draw"],
};
