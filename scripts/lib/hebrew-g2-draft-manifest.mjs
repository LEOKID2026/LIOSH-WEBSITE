...
export const HEBREW_G2_ALIGNMENT_ANCHORS = {
  "g2.fluent_words": ["שמש", "זורחת"],
  "g2.short_sentence": ["כלב", "גינה"],
  "g2.simple_punctuation_read": ["?", "שאלה"],
  "spelling_choice_niqqud": ["ספר", "אות"],
  "g2.pos_basic": ["ילד", "רץ"],
  "g2.simple_tense": ["אתמול", "הלכתי"],
  "g2.number_gender_light": ["ילדה", "ילדים"],
  "agreement_boy_plural": ["ילדים", "רצים"],
  "g2.detail_main_idea": ["דני", "כדורגל"],
  "g2.light_inference": ["מטריה", "גשם"],
  "g2.simple_sequence": ["קודם", "אחר כך"],
  "where_from_sentence": ["ים", "חוף"],
  "g2.synonyms_basic": ["שמח", "מאושר"],
  "g2.context_clue_easy": ["רעב", "אוכל"],
  "cloze_school": ["כיתה", "מורה"],
  "g2.sentence_wellformed": ["הילד", "אוכל"],
  "g2.punctuation_choice": [".", "משפט"],
  "g2.short_paragraph_choice": ["בוקר", "בית ספר"],
  "object_riddle": ["כיס", "מפתחות"],
  "role_meaning": ["רץ", "פועל"],
  "g2.describe_prompt_choice": ["פרח", "אדום"],
  "g2.situation_register": ["בוקר טוב", "מורה"],
