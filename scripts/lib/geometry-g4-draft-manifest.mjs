...
export const GEOMETRY_G4_ALIGNMENT_ANCHORS = {
  ...
  shapes_basic_properties_angles: ["ריבוע", "90°"],
  symmetry: ["ריבוע", "4"],
  quadrilaterals: ["מלבן", "ריבוע"],
  parallel_perpendicular: ["מקבילות", "90°"],
  square_perimeter: ["ריבוע", "8", "32"],
  square_area: ["ריבוע", "7", "49"],
  triangle_perimeter: ["5", "6", "7", "18"],
  triangle_angles: ["45°", "75°", "60°"],
  diagonal_square: ["ריבוע", "6"],
  diagonal_rectangle: ["3", "4", "5"],
  solids: ["תיבה", "6"],
  rectangular_prism_volume: ["3", "4", "5", "60"],
};
