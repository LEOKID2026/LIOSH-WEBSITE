...
export const GEOMETRY_G5_ALIGNMENT_ANCHORS = {
  ...
  triangle_angles: ["60°", "70°"],
  square_perimeter: ["9 ס״מ"],
  triangle_perimeter: ["5 ס״מ", "6 ס״מ", "7 ס״מ"],
  square_area: ["7 ס״מ"],
  parallelogram_area: ["8 ס״מ", "5 ס״מ"],
  trapezoid_area: ["6 ס״מ", "10 ס״מ", "4 ס״מ"],
  heights_triangle: ["10 ס״מ", "30 סמ״ר"],
  heights_parallelogram: ["8 ס״מ", "40 סמ״ר"],
