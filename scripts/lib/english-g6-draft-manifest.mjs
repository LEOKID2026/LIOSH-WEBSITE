...
export const ENGLISH_G6_ALIGNMENT_ANCHORS = {
  vocab_animals: ["The whales were swimming when we saw them"],
  vocab_community: ["Our community celebrated the festival last month"],
  vocab_emotions: ["He might feel nervous before the presentation"],
  vocab_environment: ["Climate change affects people around the world"],
  vocab_health: ["You should drink water and rest when you are tired"],
  vocab_technology: ["If the internet stops, we could use books instead"],
  vocab_travel: ["We have visited three countries so far"],
  vocab_culture: ["Music is an important part of our culture"],
  vocab_global_issues: ["Many countries work together on global issues"],
  vocab_history: ["We learned about ancient history in class"],
  grammar_complex_tenses: ["I was reading when my friend called"],
  grammar_conditionals: ["If it rains, we will stay at home"],
  grammar_modals: ["You should ask the teacher for help"],
  grammar_comparatives: ["This is the most interesting book I have read"],
  sentence_advanced: ["While I was studying, my sister was listening to music"],
  translation_technology: ["Scientists might discover new ways to save energy"],
  translation_global: ["If we protect the oceans, future generations will benefit"],
};
