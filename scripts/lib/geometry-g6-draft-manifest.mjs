...
export const GEOMETRY_G6_ALIGNMENT_ANCHORS = {
  square_perimeter: ["12 ס״מ"],
  triangle_perimeter: ["8 ס״מ", "9 ס״מ", "10 ס״מ"],
  square_area: ["9 ס״מ"],
  parallelogram_area: ["10 ס״מ", "6 ס״מ"],
  trapezoid_area: ["8 ס״מ", "12 ס״מ", "5 ס״מ"],
  triangle_angles: ["55°", "65°"],
  circle_perimeter: ["5 ס״מ", "3.14"],
  circle_area: ["4 ס״מ", "3.14"],
  pythagoras_hyp: ["3 ס״מ", "4 ס״מ"],
  pythagoras_leg: ["13 ס״מ", "12 ס״מ"],
  solids: ["גליל", "פירמידה"],
  rectangular_prism_volume: ["5 ס״מ", "4 ס״מ", "6 ס״מ"],
  prism_volume_rectangular: ["6 ס״מ", "4 ס״מ", "10 ס״מ"],
  prism_volume_triangle: ["6 ס״מ", "4 ס״מ", "10 ס״מ"],
  pyramid_volume_square: ["6 ס״מ", "9 ס״מ"],
  pyramid_volume_rectangular: ["4 ס״מ", "6 ס״מ", "9 ס״מ"],
  cylinder_volume: ["3 ס״מ", "10 ס״מ"],
  cone_volume: ["3 ס״מ", "9 ס״מ"],
  sphere_volume: ["3 ס״מ", "3.14"],
};
