/**
 * Emit docs/learning-book/hebrew/g5/drafts/*.md from manifest + content.
 * Run: node scripts/write-hebrew-g5-draft-files.mjs
 */
import fs from "fs";
...
import { getHebrewG5PageSections } from "./lib/hebrew-g5-page-content.mjs";
...
function buildPageMarkdown(pageId) {
  ...
  const sections = getHebrewG5PageSections(pageId);
...
console.log(`Wrote ${HEBREW_G5_PAGE_ORDER.length} drafts to ${DRAFTS_DIR}`);
