...
assert.equal(sanitizeActivityTitleHe("יום 11 שעה 2 — geometry", "geometry"), "יום 11 שעה 2 — גיאומטריה");
assert.equal(sanitizeActivityTitleHe("geometry — quiz", "geometry"), "גיאומטריה · בוחן");
