...
assert.equal(sanitizeActivityTitleHe("יום 11 שעה 2 — geometry", "geometry"), "יום 11 שעה 2 — הנדסה");
assert.equal(sanitizeActivityTitleHe("geometry — quiz", "geometry"), "הנדסה · בוחן");
