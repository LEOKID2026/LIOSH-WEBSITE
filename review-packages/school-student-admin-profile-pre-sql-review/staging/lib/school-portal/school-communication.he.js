...
export const SC_TAB_STUDENT_ASSIGNMENT = "ניהול שיוך תלמיד";

export const SC_SECTION_STUDENT_ACCOUNT = "חשבון תלמיד";
...
export const SC_CONFIRM_REVOKE_STUDENT = "האם לבטל את גישת התלמיד לצמיתות?";
export const SC_EMPTY_STUDENT_ACCOUNT = "לא נוצר חשבון לתלמיד זה";
...
export const SC_LABEL_RELATION = "קשר לתלמיד";
...
export const SC_BTN_DISCONNECT_PARENT = "נתק מתלמיד";
export const SC_CONFIRM_DISCONNECT_PARENT = "האם לנתק הורה זה מהתלמיד?";
...
export const SC_EMPTY_PARENT_ACCOUNTS = "לא נוצרו חשבונות הורים לתלמיד זה";
...
export const SC_DETAILS_MODAL_TITLE = "פרטי תלמיד";

export const SC_DETAILS_SECTION_STUDENT = "פרטי תלמיד";
...
export const SC_DETAILS_FIELD_STUDENT_NAME = "שם התלמיד";
...
export const SC_DETAILS_EMPTY_STATE = "לא הוזנו פרטים נוספים לתלמיד זה.";
...
export const SC_DETAILS_NAME_UPDATE_SUCCESS = "שם התלמיד עודכן בהצלחה.";
export const SC_DETAILS_NAME_UPDATE_ERROR = "לא ניתן לעדכן את שם התלמיד כרגע. נסה שוב.";
