        ...
        {activity?.mode === "live_lesson" && activity?.activityStatus === "paused" ? (
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6">
            ...
            {isExplanationOnly ? (
              ...
              >
                {currentQuestion.choices.map((c, i) => (
                  <button
                    ...
                    className={`w-full text-right px-4 py-3 rounded-xl border min-h-[44px] disabled:opacity-60 disabled:cursor-not-allowed ${
              ...
              <input
                className="w-full rounded-xl bg-black/30 border border-white/20 px-4 py-3 text-white mb-4 read-only:opacity-80 read-only:cursor-not-allowed"
                value={answerInput}
            ...
            <button
              type="button"
              disabled={busy || !answerInput.trim() || isCurrentQuestionAnswered}
