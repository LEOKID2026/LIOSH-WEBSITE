...
function synthesizeSubjectPhase3FromRows(subjectId, report) {
  ...
  if (!rows.length) {
    return {
      ...
      trendNarrativeHe: "אין מספיק שורות דוח בתקופה כדי לסכם מגמה במקצוע זה.",
      confidenceSummaryHe: "נתון דל — לא מסכמים ביטחון סטטיסטי ברמת המקצוע.",
      recommendedHomeMethodHe: null,
      whatNotToDoHe: "לא לבנות תוכנית ארוכה לפני שיש עוד תרגול בתקופה.",
      ...
      subjectDiagnosticRestraintHe:
        "אין מספיק שורות דוח בתקופה — לא מסיקים שורש קושי חוצה־נושאים ולא ממליצים על שינוי אגרסיבי.",
      subjectConclusionReadiness: "not_ready",
      subjectInterventionPriorityHe: INTERVENTION_TYPE_LABEL_HE.monitor_before_escalation,
      subjectPriorityLevel: "monitor",
      subjectPriorityReasonHe: "אין שורות דוח בתקופה — לא מדרגים עדיפות.",
      ...
      subjectMemoryNarrativeHe: "אין שורות דוח בתקופה — לא מסכמים סוג טעות חוזר או מגמה לאורך זמן.",
      ...
      subjectEffectivenessNarrativeHe: "אין שורות דוח בתקופה — לא מעריכים תגובה לתמיכה.",
      ...
      subjectSequenceNarrativeHe: "אין שורות דוח בתקופה — לא מסכמים רצף תמיכה.",
      ...
      subjectOutcomeNarrativeHe: "אין שורות דוח בתקופה — לא מסכמים זיכרון המלצה או תוצאה.",
      ...
      subjectGateNarrativeHe: "אין שורות דוח בתקופה — עדיין מוקדם להחלטה בטוחה.",
      ...
      subjectDependencyNarrativeHe: "אין שורות דוח בתקופה — לא מסכמים תלות יסוד.",
    };
  }
  ...
  const whatNotToDoHe = avoid.length ? avoid.join(" ") : "לא לקבוע שינוי דרמטי בלי עוד תרגול בתקופה.";
