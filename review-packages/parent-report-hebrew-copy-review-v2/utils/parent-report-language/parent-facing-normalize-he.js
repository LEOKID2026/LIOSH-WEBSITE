...
export function normalizeParentFacingHe(raw) {
  ...
  const phrasePairs = [
    ...
    [/לא\s+סוגרים\s+מסקנה\s+חזקה/giu, "עדיין מוקדם לקבוע מסקנה ברורה"],
    [/מסקנה\s+חזקה/giu, "מסקנה ברורה"],
    ...
    [/נפח\s+בטווח/giu, "תרגול בתקופה"],
    [/מתייצב\s+נפח/giu, "יתקבל עוד תרגול"],
    [/יימלא\s+נפח/giu, "יתקבל עוד תרגול"],
    [/סוגר\s+מסקנה/giu, "קובע מסקנה"],
    [/לסגור\s+מסקנה/giu, "לקבוע מסקנה"],
    [/סוגרים\s+מסקנה/giu, "קובעים מסקנה"],
    [/משוקלל/giu, "כולל"],
  ];
