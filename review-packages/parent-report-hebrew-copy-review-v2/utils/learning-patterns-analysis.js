...
function buildSummaryHe(
  ...
  if (
    ...
    if (mistakeEventCount >= 0 && mistakeEventCount < 5) {
      return `${opening} עדיין מעט נתון בתקופה שנבחרה — אחרי עוד קצת תרגול אפשר יהיה לנסח תמונה מלאה יותר.`;
    }
    return null;
  }
  ...
  if (!rows.length) {
    return {
      ...
      subjectDiagnosticRestraintHe:
        "בתקופה שנבחרה אין מספיק נתוני תרגול — לא מסיקים שורש קושי חוצה־נושאים ולא ממליצים על שינוי אגרסיבי.",
      subjectConclusionReadiness: "not_ready",
      subjectInterventionPriorityHe: INTERVENTION_TYPE_LABEL_HE.monitor_before_escalation,
      subjectPriorityLevel: "monitor",
      subjectPriorityReasonHe: "בתקופה שנבחרה אין מספיק נתוני תרגול — לא מדרגים עדיפות.",
      ...
      subjectMemoryNarrativeHe: "בתקופה שנבחרה אין מספיק נתוני תרגול — לא מסכמים סוג טעות חוזר או מגמה לאורך זמן.",
      ...
      subjectEffectivenessNarrativeHe: "בתקופה שנבחרה אין מספיק נתוני תרגול — לא מעריכים תגובה לתמיכה.",
      ...
      subjectSequenceNarrativeHe: "בתקופה שנבחרה אין מספיק נתוני תרגול — לא מסכמים רצף תמיכה.",
      ...
      subjectOutcomeNarrativeHe: "בתקופה שנבחרה אין מספיק נתוני תרגול — לא מסכמים זיכרון המלצה או תוצאה.",
      ...
      subjectGateNarrativeHe: "בתקופה שנבחרה אין מספיק נתוני תרגול — עדיין מוקדם להחלטה בטוחה.",
      ...
      subjectFoundationFirstPriorityHe: "בתקופה שנבחרה אין מספיק נתוני תרגול — לא מדרגים יסוד מול מקומי.",
      subjectDependencyNarrativeHe: "בתקופה שנבחרה אין מספיק נתוני תרגול — לא מסכמים תלות יסוד.",
    };
  }
