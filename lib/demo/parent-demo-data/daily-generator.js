...
import { applyAriDemoInitialDataTopic } from "./demo-ari-initial-data-topic.server.js";
...
export function generateDemoLearningRowsForRange(childId, fromYmd, toYmd) {
  ...
  applyAriDemoInitialDataTopic(childId, startYmd, endYmd, child, sessions, answers);
