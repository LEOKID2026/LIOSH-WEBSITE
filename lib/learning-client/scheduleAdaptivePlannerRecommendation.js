...
const LEGACY_NEXT_ACTION_BY_ADC = Object.freeze({
  collect_more_evidence: "pause_collect_more_data",
  give_probe_questions: "probe_skill",
  practice_more: "practice_current",
  targeted_practice: "practice_current",
  strengthen_prerequisite: "review_prerequisite",
  remove_timer: "practice_current",
  reduce_reading_load: "practice_current",
  guided_to_independent_transition: "practice_current",
  maintain: "maintain_skill",
  monitor_before_escalation: "pause_collect_more_data",
  advance_cautiously: "advance_skill",
});
...
export function plannerCompatibilityPayloadFromActionDecisionV2(
  ...
  return {
    ...
    recommendation: {
      nextAction:
        LEGACY_NEXT_ACTION_BY_ADC[decision.action] ||
