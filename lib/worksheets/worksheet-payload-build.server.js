...
export function worksheetPayloadToPreviewHtml(payload) {
  ...
  const renderQuestionArticle = (q) => {
      ...
      const diagram = diagramSvg
        ...
        : "";
      const answerLine =
        useMathPrintPages && !q.optionsHe?.length
          ? `<div class="worksheet-math-answer-line" aria-hidden="true"><span class="worksheet-math-answer-line-label">תשובה:</span><span class="worksheet-math-answer-line-field"></span></div>`
          : "";
      return `
