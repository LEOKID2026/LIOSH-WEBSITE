              ...
              .map((o, i) => {
                ...
                const cls =
                  !useFraction && useLtr
                    ...
                    : "";
                return `<li class="worksheet-option-cell"><span class="worksheet-option-label">${["א", "ב", "ג", "ד"][i] || i + 1}.</span><span class="worksheet-option-text">${useFraction ? inner : `<span${cls}>${inner}</span>`}</span></li>`;
              })
              .join("")}</ol>`
          : "";
