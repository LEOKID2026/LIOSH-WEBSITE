...
export const API_ERROR_LABEL_HE = {
  ...
  student_limit_reached: "הגעתם למכסת התלמידים של בית הספר",
  main_admin_required: "פעולה זו זמינה למנהל/ת המערכת הראשי/ת בלבד",
  auth_list_failed: "לא ניתן לטעון משתמשי Auth — בדקו ש-Service Role מוגדר בשרת",
  auth_users_unavailable: "לא נמצאו משתמשי Auth ולא ניתן לבנות רשימה מהמסד",
