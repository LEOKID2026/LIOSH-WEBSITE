...
export const BOOK_GRADE_THEMES = Object.freeze({
  ...
  g3: Object.freeze({
    id: "g3",
    label: "Grade 3 — green/emerald",
    cssVars: Object.freeze({
      "--book-dot-glow": "rgba(52, 211, 153, 0.5)",
    }),
    classes: Object.freeze({
      pageBg: "bg-gradient-to-b from-[#0a1812] via-[#0c2018] to-[#0e2820]",
      headerBg: "bg-[#0a1812]/95",
      footerBg: "bg-[#0a1812]/96",
      tocButton:
        "border-emerald-400/35 bg-emerald-500/20 text-emerald-50 hover:bg-emerald-500/30",
      activePageTitle: "text-emerald-200/95",
      indexFooterLink: "text-emerald-300/80 hover:text-emerald-200 hover:underline",
      cardArticle:
        "border-emerald-400/25 bg-gradient-to-b from-emerald-950/40 via-[#0c2418]/90 to-[#0a1812]/95",
      dotActive: "bg-emerald-400",
      sectionHeading: "text-emerald-100",
      practiceCta:
        "border-teal-300/40 bg-gradient-to-b from-emerald-500/28 to-teal-600/26 text-emerald-50 hover:from-emerald-500/38 hover:to-teal-600/32 hover:border-teal-200/45 shadow-[0_8px_24px_rgba(16,185,129,0.16)]",
      practiceCtaSub: "text-emerald-100/85",
      navPrevButton:
        "border-emerald-400/35 bg-emerald-500/20 text-emerald-50 hover:bg-emerald-500/30",
      navNextButton:
        "border-teal-400/35 bg-teal-500/25 text-teal-50 hover:bg-teal-500/35",
      topicPrevLink:
        "border-emerald-400/25 bg-gradient-to-l from-emerald-950/50 to-emerald-500/10 text-emerald-100/90 hover:border-emerald-400/40 hover:from-emerald-900/55 hover:to-emerald-500/15",
      topicPrevLabel: "text-emerald-200/65",
      topicNextLink:
        "border-teal-400/25 bg-gradient-to-l from-teal-950/45 to-teal-500/10 text-teal-100/90 hover:border-teal-400/40 hover:from-teal-900/50 hover:to-teal-500/15",
      topicNextLabel: "text-teal-200/65",
      tocModalPanel:
        "border-white/15 bg-gradient-to-b from-[#0c2018] to-[#0a1812]",
      tocBatchHeading: "text-emerald-300/90",
      tocActiveItem:
        "bg-emerald-500/28 border border-emerald-400/40 text-emerald-50 font-semibold",
      tocFooterLink: "text-emerald-300 hover:text-emerald-200",
      indexBatchHeading: "text-emerald-200",
      indexTopicTile:
        "border-emerald-400/20 bg-gradient-to-l from-emerald-950/45 to-white/[0.04] hover:border-teal-400/35 hover:from-teal-950/35 hover:to-emerald-500/10",
      indexTopicIcon: "text-emerald-400",
      diagramPanel:
        "border-emerald-400/20 bg-gradient-to-b from-emerald-950/30 via-[#0c2418]/80 to-[#0a1812]/85",
      diagramDot:
        "bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.45)]",
      diagramAccentStrong: "text-emerald-300/90",
      diagramAccent: "text-emerald-100",
      diagramAccentMuted: "text-emerald-100/85",
      diagramAccentSoft: "text-emerald-200/80",
      diagramSecondary: "text-green-100",
      diagramSecondaryMuted: "text-green-100/95",
      diagramHighlightCell:
        "bg-emerald-500/30 text-emerald-50 ring-1 ring-emerald-400/40",
      diagramHighlightBorder:
        "border-emerald-400/45 bg-emerald-500/22 text-emerald-50",
      diagramColumn:
        "border-emerald-400/30 bg-emerald-950/22",
      diagramColumnLabel: "text-emerald-100",
      inlineCodeBg: "bg-emerald-950/45",
      mathText: "text-emerald-50",
      inlineCodeText: "text-emerald-100",
    }),
  }),
