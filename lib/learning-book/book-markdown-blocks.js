...
/**
 * @typedef {{ type: 'code', content: string } | { type: 'geometry_diagram', diagramType: string, options: Record<string, string> } | { type: 'hr' } | { type: 'ul' | 'ol', items: string[][] } | { type: 'prose', lines: string[] }} BookMarkdownBlock
 */
