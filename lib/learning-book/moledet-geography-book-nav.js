...
export function getMoledetGeographyBookPracticePath() {
  return `/learning/moledet-geography-master?${LEARNING_BOOK_PRACTICE_FROM_QUERY}=1`;
}
...
export function handleMoledetGeographyBookClose(router, grade) {
  handleLearningBookCloseToMaster(
    router,
    getMoledetGeographyBookSubjectForGrade(grade) || "moledet",
    grade,
