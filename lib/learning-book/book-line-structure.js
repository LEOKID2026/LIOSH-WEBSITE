...
const KNOWN_LABEL_PREFIX =
  /^(?:שאלה|שלב\s*\d+|תשובה|דוגמה|רמז|זכרו|טיפ|קל\s*לטעות|משמעות|נוסחה|עשרות|אחדות|סה״כ|סה"כ|מפרקים|מחברים|היה|הוציא|נשאר|מה\s+(?:יודעים|מבקשים|עושים)|חשבו|בדקו|ספרו|מצאו)\s*:/u;
