...
import { toStudentLearningPath } from "../pwa/pwa-scope-routes.js";
...
export function getLearningBookMasterPath(subject) {
  const key = String(subject || "").toLowerCase();
  if (key === "geometry") return toStudentLearningPath("/learning/geometry-master");
  if (key === "science") return toStudentLearningPath("/learning/science-master");
  if (key === "hebrew") return toStudentLearningPath("/learning/hebrew-master");
  if (key === "english") return toStudentLearningPath("/learning/english-master");
  if (key === "moledet" || key === "geography") return toStudentLearningPath("/learning/moledet-geography-master");
  return toStudentLearningPath("/learning/math-master");
}
