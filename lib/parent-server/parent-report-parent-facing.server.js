...
import {
  resolveTopicInsightCopySemantics,
...
export function buildParentInsightsHe(payload) {
  ...
  if (
    ...
    const topicSemantics = resolveTopicInsightCopySemantics(
      payload,
      weakTopic.subject,
      weakTopic.topicKey,
    );
    const line = topicAttentionInsightHe({
      ...
      rootCause: topicSemantics.rootCause,
      diagnosticType: topicSemantics.diagnosticType,
      patternId: topicSemantics.patternId,
      engineAction: "",
    });
