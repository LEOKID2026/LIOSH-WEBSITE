...
/**
 * Ordered cleanup for arcade + any legacy RESTRICT references to students.
 * Hosted rooms are removed before player rows so room CASCADE clears co-players safely.
 *
 * @param {import('@supabase/supabase-js').SupabaseClient} db
