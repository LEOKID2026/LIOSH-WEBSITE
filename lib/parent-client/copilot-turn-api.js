...
import {
  ...
  PARENT_DEMO_SYNTHETIC_BEARER,
} from "../demo/parent-demo-mode.client.js";
...
export async function resolveParentReportBearerToken() {
  ...
  if (hasParentDemoSession()) {
    return PARENT_DEMO_SYNTHETIC_BEARER;
  }
...
export async function postParentCopilotTurn(body) {
  ...
  const endpoint = hasParentDemoSession()
    ? "/api/demo/parent/copilot-turn"
