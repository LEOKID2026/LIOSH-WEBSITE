...
export const ADMIN_ALL_ACCOUNTS_LIST_DEGRADED =
  "הרשימה נבנתה ממסד הנתונים (Auth listUsers לא החזיר משתמשים).";
...
export const ADMIN_ACCOUNT_CLASS_QA = "חשבון בדיקה / QA";
...
export const PLAN_CODE_LABELS_HE = {
  ...
  teacher_basic_20: "תוכנית בסיסית — עד 20 תלמידים",
  teacher_pro_50: "תוכנית מתקדמת — עד 50 תלמידים",
