...
export const EDUCATIONAL_GAME_REGISTRY = Object.freeze({
  ...
  "leo-gifts": {
    ...
    blurbHe: "חלוקה לקבוצות, חלוקה שווה ושארית",
    emoji: "🍬",
    ...
    help: {
      howToPlay:
        "חלקו פריטים בין ילדים או לשקיות - מצאו כמה בכל קבוצה וכמה נשאר, ולחצו בדיקה.",
      scoring:
        "תשובה נכונה +30, בונוס זמן, רצף. אחרי כמה ניסיונות מוצג הפתרון ועוברים הלאה.",
      rewards: "מטבעות לפי שאלות נכונות, דיוק, רצף ורמת קושי.",
      tip: "שימו לב אם מחפשים כמה לכל ילד או כמה שקיות אפשר להכין.",
    },
  },
  "leo-bakery": {
    id: "leo-bakery",
    ...
    blurbHe: "כפל, קבוצות שוות וגורם חסר",
    emoji: "🥐",
    ...
    help: {
      howToPlay:
        "בנו מגשים, מצאו סכום כולל או גורם חסר, ולפעמים סדרו מחדש את אותה כמות. לחצו בדיקה.",
      scoring:
        "תשובה נכונה +30, בונוס זמן ורצף. אחרי כמה ניסיונות מוצג התרגיל המלא.",
      rewards: "מטבעות לפי הזמנות נכונות, דיוק, רצף ורמת קושי.",
      tip: "חשבו מגשים × כמות בכל מגש - אל תסתמכו רק על ספירת אייקונים.",
    },
  },
  "leo-number-path": {
    id: "leo-number-path",
    ...
    blurbHe: "זוגי ואי־זוגי, כפולות וסדרות",
    emoji: "🔢",
    ...
    help: {
      howToPlay:
        "בחרו מספרים לפי הכלל - זוגיים, כפולות, קפיצות או סדרה - ולחצו בדיקה. הסדר חשוב בקפיצות ובסדרות.",
      scoring:
        "נכון בניסיון ראשון +30, שני +20, שלישי +10. אחרי 3 טעויות מוצג המסלול הנכון.",
      rewards: "מטבעות לפי משימות שהצלחתם, דיוק, רצף והשלמת המסלול.",
      tip: "קראו את הכלל - התחלה וגודל קפיצה, בלי לנחש לפי מיקום על הלוח.",
    },
  },
  "leo-pizzeria": {
    id: "leo-pizzeria",
    ...
    help: {
      howToPlay:
        "בנו שברים על פיצה, זהו שבר מציור, השלימו לשלם, השוו או מצאו שברים שווים - לפי המשימה.",
      scoring:
        "תשובה נכונה +30, רצף בונוס. אחרי כמה ניסיונות מוצג הפתרון.",
      rewards: "מטבעות לפי לקוחות ששירתתם, דיוק, רצף ורמת קושי.",
      tip: "שימו לב למונה ולמכנה - החלקים בפיצה תמיד שווים.",
    },
  },
  "leo-word-train": {
    id: "leo-word-train",
