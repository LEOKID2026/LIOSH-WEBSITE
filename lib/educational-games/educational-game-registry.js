...
export const EDUCATIONAL_GAME_KEYS = Object.freeze(["recycling-factory", "leo-supermarket", "leo-lab"]);
...
export const EDUCATIONAL_GAME_REGISTRY = Object.freeze({
  ...
  "leo-supermarket": {
    ...
    help: {
      ...
      rewards: "מטבעות לפי כמה לקוחות שירתתם, דיוק, רצף ורמת קושי — גם אם לא סיימתם את כל 30 הלקוחות.",
