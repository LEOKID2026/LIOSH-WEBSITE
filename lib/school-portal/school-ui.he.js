...
export const SCHOOL_SUBJECT_LABELS = {
  math: "מתמטיקה",
  english: "אנגלית",
  hebrew: "עברית",
  science: "מדעים",
...
/** @type {Record<string, string>} */
export const SCHOOL_ACTIVITY_MODE_LABELS = {
...
/** @type {Record<string, string>} */
export const SCHOOL_ACTIVITY_STATUS_LABELS = {
  draft: "טיוטה",
  active: "פעילה",
  paused: "מושהית",
  closed: "נסגרה",
...
export function schoolSubjectLabelHe(key) {
  ...
  return SCHOOL_SUBJECT_LABELS[k] || k;
}
...
export function schoolActivityModeHe(mode) {
  ...
  return SCHOOL_ACTIVITY_MODE_LABELS[k] || k;
}
...
export function schoolActivityStatusHe(status) {
  ...
  return SCHOOL_ACTIVITY_STATUS_LABELS[k] || k;
}
