...
export const SCHOOL_OPERATOR_ACCESS_ADMIN_SECTION = "ניהול גישות תלמידים והורים";
export const SCHOOL_OPERATOR_ACCESS_ADMIN_DESC =
  "חיפוש תלמידים, יצירה ואיפוס של פרטי כניסה לתלמידים והורים, וניהול חשבונות גישה.";
export const SCHOOL_OPERATOR_DATA_VIEWER_SECTION = "צפייה בדוחות ופרטי תלמידים";
export const SCHOOL_OPERATOR_DATA_VIEWER_DESC =
  "צפייה בדוחות למידה ובפרטי תלמידים המותרים לפי ההרשאה.";
export const SCHOOL_OPERATOR_GO_TO_STUDENTS = "מעבר לתלמידים";
