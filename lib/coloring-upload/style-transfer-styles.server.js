...
const COMIC_NEGATIVE =
  "pop art, halftone dots, ben-day dots, oversaturated, grainy, vintage comic, photorealistic, blurry, border, frame, white border, margin, photo frame, cropped edges, padded, cropped head, cropped feet, cut off subject, outpainting, expanded background, full body generation, extra legs, extra limbs, changed composition, zoomed out";
