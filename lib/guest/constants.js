...
export const GUEST_LOCK_MESSAGE_HE = "לא זמין במצב אורch";
export const GUEST_GAME_LOCK_MESSAGE_HE = "לא זמין במצb אורch";
export const GUEST_TOPIC_LOCK_MESSAGE_HE = "נושא זה נעול במצb אורch";
