...
export const PLACEMENT_DIFFICULTY_SETTINGS = Object.freeze({
  easy: { grid: 3, holes: 4, timeSec: 300, parMoves: 14, label: "4 חלקים" },
  medium: { grid: 4, holes: 7, timeSec: 240, parMoves: 28, label: "7 חלקים" },
  hard: { grid: 5, holes: 10, timeSec: 300, parMoves: 48, label: "10 חלקים" },
});
