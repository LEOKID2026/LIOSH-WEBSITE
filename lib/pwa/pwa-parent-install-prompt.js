...
function handleAppInstalled() {
  ...
  logPwaInstallEvent("parent:appinstalled", { app: "P LEO K" });
...
export async function promptParentPwaInstall() {
  if (!deferredParentPrompt) {
    logPwaInstallEvent("parent:prompt-unavailable", { app: "P LEO K" });
  ...
  logPwaInstallEvent("parent:prompt-called", { app: "P LEO K" });
