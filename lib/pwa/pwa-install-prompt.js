...
function handleAppInstalled() {
  ...
  logPwaInstallEvent("student:appinstalled", { app: "LEO K" });
...
export async function promptPwaInstall() {
  if (!deferredPrompt) {
    logPwaInstallEvent("student:prompt-unavailable", { app: "LEO K" });
  ...
  logPwaInstallEvent("student:prompt-called", { app: "LEO K" });
