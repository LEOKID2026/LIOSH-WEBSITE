...
const PORTAL_ACCENT = {
  ...
  parent: {
    bright: {
      ...
      iosHelpTrigger:
        "inline-flex h-11 w-full items-center justify-center rounded-full bg-gradient-to-r from-cyan-500 via-teal-500 to-emerald-600 px-5 text-sm font-bold text-white shadow-md transition-all hover:from-cyan-600 hover:via-teal-600 hover:to-emerald-700 hover:shadow-lg",
    },
    classic: {
      badge: "text-teal-300",
      ...
      iosHelpDoneBtn:
        "inline-flex h-9 items-center justify-center rounded-full bg-gradient-to-r from-teal-500 via-emerald-500 to-cyan-600 px-5 text-sm font-bold text-white shadow-md transition-all hover:from-teal-600 hover:via-emerald-600 hover:to-cyan-700",
      iosHelpTrigger:
        "inline-flex h-11 w-full items-center justify-center rounded-full bg-gradient-to-r from-cyan-600 via-teal-600 to-emerald-700 px-5 text-sm font-bold text-white shadow-md transition-all hover:from-cyan-700 hover:via-teal-700 hover:to-emerald-800 hover:shadow-lg",
    },
  },
  teacher: {
    bright: {
      ...
      iosHelpTrigger:
        "inline-flex h-11 w-full items-center justify-center rounded-full bg-gradient-to-r from-violet-500 via-purple-600 to-orange-500 px-5 text-sm font-bold text-white shadow-md transition-all hover:from-violet-600 hover:via-purple-700 hover:to-orange-600 hover:shadow-lg",
    },
    classic: {
      ...
      iosHelpDoneBtn:
        "inline-flex h-9 items-center justify-center rounded-full bg-gradient-to-r from-indigo-500 via-violet-600 to-orange-500 px-5 text-sm font-bold text-white shadow-md transition-all hover:from-indigo-600 hover:via-violet-700 hover:to-orange-600",
      iosHelpTrigger:
        "inline-flex h-11 w-full items-center justify-center rounded-full bg-gradient-to-r from-violet-600 via-purple-700 to-orange-600 px-5 text-sm font-bold text-white shadow-md transition-all hover:from-violet-700 hover:via-purple-800 hover:to-orange-700 hover:shadow-lg",
    },
  },
};
