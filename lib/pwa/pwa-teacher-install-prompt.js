...
function handleAppInstalled() {
  ...
  logPwaInstallEvent("teacher:appinstalled", { app: "T LEO K" });
...
export async function promptTeacherPwaInstall() {
  if (!deferredTeacherPrompt) {
    logPwaInstallEvent("teacher:prompt-unavailable", { app: "T LEO K" });
  ...
  logPwaInstallEvent("teacher:prompt-called", { app: "T LEO K" });
