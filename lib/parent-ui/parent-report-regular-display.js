...
import {
  applyDemoParentReportDisplayQuotes,
  applyDemoParentReportDisplayQuotesToDisplayModel,
} from "../demo/parent-demo-display-quotes.client.js";
...
export function buildRegularReportViewModel(report) {
  ...
  if (filteredReport.demo === true || filteredReport._reportApiPayload?.demo === true) {
    applyDemoParentReportDisplayQuotes(filteredReport);
    const displayAdjusted = applyDemoParentReportDisplayQuotesToDisplayModel(display);
    return {
      registeredGradeKey,
