...
export function getParentReportPageShellClass(isBright) {
  return isBright
...
/** @param {boolean} isBright */
export function getParentReportDetailedShellClass(isBright) {
  return isBright
...
/** @param {boolean} isBright */
export function getParentReportPageContentStyle(isBright) {
  return {
...
/** @param {boolean} isBright */
export function getParentReportDetailedContentStyle(isBright) {
  return {
