...
/** Public worksheet visit analytics (page view only) */
export function rejectIfPublicWorksheetAnalyticsEventRateLimited(req, res) {
  return rejectIfRateLimited(req, res, {
    namespace: "public-worksheet-analytics-event",
    maxAttempts: 30,
    windowMs: TEN_MIN,
  });
}
