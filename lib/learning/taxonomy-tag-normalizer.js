...
export const TAG_ALIASES_TO_CANONICAL = Object.freeze({
  ...
  grammar_forms: "grammar_error",
  // Hebrew MCQ banks often emit bare "agreement_error"; keep EN agreement_error intact
  // via normalize path that only aliases when not already canonical for E-02.
  hebrew_agreement_error: "grammar_agreement_error",
