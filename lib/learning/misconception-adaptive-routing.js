...
export const PROBE_KIND_BY_TAG = Object.freeze({
  ...
  perimeter_area_confusion: "rectangle_area",
  forgot_divide_by_2: "triangle_area",
  volume_formula_error: "rectangular_prism_volume",
  pythagorean_relation_error: "pythagoras_hyp",
  triangle_angle_sum_error: "triangle_angles",
  parallelogram_area_error: "parallelogram_area",
  ...
  phonics_minimal_pair_error: "first_words_cvc",
  ...
  pythagorean_relation_error: "pythagoras",
  ...Object.fromEntries(
    MATH_TOPIC_COVERAGE_DEFINITIONS.map((definition) => [
      definition.tag,
      definition.questionKind,
    ])
  ),
});
