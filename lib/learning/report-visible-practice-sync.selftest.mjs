...
dbInput.subjects.math.topics = {
  addition: { topicBaseKey: "addition", total: 30, correct: 28, wrong: 2, accuracy: 93.33, durationSeconds: 2000 },
};
dbInput.subjects.geometry.topics = {
  shapes: { topicBaseKey: "shapes", total: 20, correct: 17, wrong: 3, accuracy: 85, durationSeconds: 1600 },
};
