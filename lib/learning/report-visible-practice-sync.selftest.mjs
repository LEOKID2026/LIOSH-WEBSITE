...
assert.ok(report.summary.diagnosticOverviewHe.notPracticedSubjectsSummaryHe == null);
const serialized = JSON.stringify(report.summary.diagnosticOverviewHe || {});
assert.ok(!serialized.includes("לא תורגל"));
assert.ok(!serialized.includes("מקצועות שלא תורגל"));
