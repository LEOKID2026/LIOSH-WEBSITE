...
export const STUDENT_ACTIVITY_LAYOUT = {
  ...
  /** Site footer height — keep scratchpad dock flush above legal HUD */
  layoutFooterOffsetPx: 52,
  ...
  scratchpadDockToggleRow:
    "shrink-0 min-h-[34px] w-full flex items-center justify-center",
  scratchpadDockFinishRow: "w-full flex flex-row flex-wrap gap-1.5 justify-center items-center",
