...
export const STUDENT_ACTIVITY_LAYOUT = {
   ...
   * Modest min-height softens math layout-toggle reflow only.
   */
  questionStage:
    "relative w-full min-h-[8rem] sm:min-h-[9rem] flex flex-col items-center justify-center gap-2 overflow-visible px-1 sm:px-2 py-1",
  questionStageInner:
