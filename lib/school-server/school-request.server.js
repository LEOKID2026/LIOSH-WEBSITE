...
/**
 * School manager or operator bootstrap for `/api/school/me`.
 * @param {import('http').ServerResponse} res
 * @param {string} authHeader
 */
export async function requireSchoolPortalMeContext(res, authHeader) {
  if (rejectIfTeacherPortalDisabled(res)) {
    return { ok: false, stopped: true };
  }
 ...
 */
export async function requireSchoolCredentialAdminContext(res, authHeader, schoolId) {
  if (rejectIfTeacherPortalDisabled(res)) {
    return { ok: false, stopped: true };
  }
 ...
 * @param {string} schoolId
 */
export async function requireSchoolDataViewerContext(res, authHeader, schoolId) {
  if (rejectIfTeacherPortalDisabled(res)) {
    return { ok: false, stopped: true };
  }
 ...
 * @param {string} authHeader
 */
export async function requireSchoolCredentialAdminApiContext(res, authHeader) {
  if (rejectIfTeacherPortalDisabled(res)) {
    return { ok: false, stopped: true };
  }
