 ...
 * @param {string} teacherId
 */
export async function generateUniqueGuardianUsername(serviceRole, teacherId) {
  return generateTeacherPrefixedGuardianUsername(serviceRole, teacherId);
}
...
export async function createTeacherGuardianAccess(input) {
  ...
  const usernameGen = await generateTeacherPrefixedGuardianUsername(serviceRole, teacherId);
