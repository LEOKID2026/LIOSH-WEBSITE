...
/** During local/dev builds, portal defaults on unless env explicitly sets the flag. */
...
export function isTeacherPortalEnabled() {
  return envFlagOrDevDefault("TEACHER_PORTAL_ENABLED", false);
}
...
export function isTeacherPortalUiCopyEnabled() {
  return envFlagOrDevDefault("TEACHER_PORTAL_UI_COPY_ENABLED", false);
}
