...
export async function buildTeacherDashboardPayload(input) {
  ...
  // Use UTC-midnight-aligned window to match resolveTeacherReportDateRange default.
  // This ensures the dashboard and all report surfaces share the same date boundary
  // so classroom-activity rollups are included or excluded consistently.
