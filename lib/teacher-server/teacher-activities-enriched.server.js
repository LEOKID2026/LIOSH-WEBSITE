 ...
 */
export function buildAllSkillsFromAttempts(attempts, subject, activityTopic) {
...
export async function buildEnrichedActivityReportPayload(
  ...
  const resolveSkillLabelHe = (skillKey, ctx) =>
    activityExportSkillLabelHe(skillKey, ctx);
  ...
  const allSkills = buildAllSkillsFromAttempts(attempts || [], subject, activityTopic);
