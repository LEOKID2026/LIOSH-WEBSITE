...
export const REG_TEACHER_INVITE_ONLY_LOGIN_NOTE =
  "יש לך כבר חשבון שהוזמן על ידי הצוות? התחבר/י כאן. מעוניינ/ת בגישה חדשה? עבר/י ללשונית בקשת גישה.";
...
export const REG_TEACHER_TAB = "בקשת גישה";
...
export const REG_SCHOOL_APPROX_STUDENTS_LABEL = "מספר תלמידים משוער";
