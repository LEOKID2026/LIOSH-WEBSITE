...
export const STUDENT_CLASSIC = Object.freeze({
  ...
  hubBackLink:
    "inline-flex items-center justify-center rounded-xl border border-white/15 bg-white/5 px-4 py-2 text-sm md:text-base font-semibold text-white/90 hover:bg-white/10 hover:text-white transition min-h-11 shadow-sm shrink-0",
  hubTopBar:
