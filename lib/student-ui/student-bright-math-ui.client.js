...
export const MATH_BRIGHT = Object.freeze({
  ...
  adSlot:
    "w-full max-w-lg md:max-w-3xl lg:max-w-4xl xl:max-w-4xl mx-auto shrink-0 h-10 md:h-12 min-h-[2.5rem] rounded-lg border border-dashed border-teal-300/45 bg-teal-50/25 pointer-events-none",
  btnSoundOn:
  ...
  answerWrap:
    "w-full mb-3 p-4 md:p-5 max-[420px]:p-1.5 max-[420px]:mb-1.5 rounded-xl bg-sky-100 border-2 border-sky-400 shadow-md shadow-sky-200/70 ring-1 ring-sky-300/60",
  ...
  vkKeyCompact:
    "min-h-[44px] h-11 max-[420px]:min-h-7 max-[420px]:h-7 rounded-lg border-2 border-sky-400 bg-white text-slate-900 text-lg max-[420px]:text-sm font-bold tabular-nums leading-none active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed hover:border-sky-500 hover:bg-sky-50 transition-transform shadow-sm",
  vkSubmitGreen:
    "col-span-3 min-h-[44px] h-11 max-[420px]:min-h-7 max-[420px]:h-7 rounded-lg border-2 border-emerald-600 bg-emerald-500 text-white text-base max-[420px]:text-sm font-bold leading-none active:scale-[0.98] disabled:opacity-40 hover:bg-emerald-600 transition-transform shadow-sm",
  vkSubmitBlue:
    "col-span-3 min-h-[44px] h-11 max-[420px]:min-h-7 max-[420px]:h-7 rounded-lg border-2 border-cyan-600 bg-cyan-500 text-white text-base max-[420px]:text-sm font-bold leading-none active:scale-[0.98] disabled:opacity-40 hover:bg-cyan-600 transition-transform shadow-sm",
  vkPad:
    "mt-2 max-[420px]:mt-0.5 w-full max-w-[320px] max-[420px]:max-w-[260px] mx-auto p-3 max-[420px]:p-1 rounded-xl bg-white/95 border-2 border-sky-400 shadow-sm",

  inputDesktop:
    "w-full px-4 py-5 max-[420px]:px-3 max-[420px]:py-2.5 rounded-xl bg-white border-2 border-sky-500 text-slate-900 text-3xl max-[420px]:text-xl font-extrabold text-center leading-none tabular-nums shadow-inner shadow-sky-100 ring-2 ring-sky-200/80 disabled:opacity-50 disabled:bg-slate-100",
  inputMobile:
    "w-full h-12 max-h-12 max-[420px]:h-9 max-[420px]:max-h-9 px-3 max-[420px]:px-2 py-0 rounded-xl bg-white border-2 border-sky-500 text-slate-900 text-xl max-[420px]:text-base font-bold text-center leading-none tabular-nums placeholder:text-slate-400 placeholder:font-normal disabled:opacity-50 disabled:bg-slate-100 [appearance:textfield] overflow-hidden text-ellipsis whitespace-nowrap shadow-inner shadow-sky-100 ring-2 ring-sky-200/80",
  ...
  floatBtnHelper:
    "px-3 py-1.5 rounded-lg text-xs font-bold shadow-lg transition-all text-white text-center whitespace-nowrap",
