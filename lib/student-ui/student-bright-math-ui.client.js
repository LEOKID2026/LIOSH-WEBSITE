...
export const MATH_BRIGHT = Object.freeze({
  ...
  answerWrap:
    "w-full mb-3 p-4 md:p-5 max-[420px]:p-2 max-[420px]:mb-2 rounded-xl bg-sky-100 border-2 border-sky-400 shadow-md shadow-sky-200/70 ring-1 ring-sky-300/60",
  ...
  vkKeyCompact:
    "min-h-[44px] h-11 max-[420px]:min-h-[36px] max-[420px]:h-9 rounded-lg border-2 border-sky-400 bg-white text-slate-900 text-lg max-[420px]:text-base font-bold tabular-nums leading-none active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed hover:border-sky-500 hover:bg-sky-50 transition-transform shadow-sm",
  vkSubmitGreen:
    "col-span-3 min-h-[44px] h-11 max-[420px]:min-h-[36px] max-[420px]:h-9 rounded-lg border-2 border-emerald-600 bg-emerald-500 text-white text-base max-[420px]:text-sm font-bold leading-none active:scale-[0.98] disabled:opacity-40 hover:bg-emerald-600 transition-transform shadow-sm",
  vkSubmitBlue:
    "col-span-3 min-h-[44px] h-11 max-[420px]:min-h-[36px] max-[420px]:h-9 rounded-lg border-2 border-cyan-600 bg-cyan-500 text-white text-base max-[420px]:text-sm font-bold leading-none active:scale-[0.98] disabled:opacity-40 hover:bg-cyan-600 transition-transform shadow-sm",
  vkPad:
    "mt-2 max-[420px]:mt-1 w-full max-w-[320px] max-[420px]:max-w-[280px] mx-auto p-3 max-[420px]:p-1.5 rounded-xl bg-white/95 border-2 border-sky-400 shadow-sm",
  ...
  inputMobile:
    "w-full h-12 max-h-12 max-[420px]:h-10 max-[420px]:max-h-10 px-3 max-[420px]:px-2 py-0 rounded-xl bg-white border-2 border-sky-500 text-slate-900 text-xl max-[420px]:text-lg font-bold text-center leading-none tabular-nums placeholder:text-slate-400 placeholder:font-normal disabled:opacity-50 disabled:bg-slate-100 [appearance:textfield] overflow-hidden text-ellipsis whitespace-nowrap shadow-inner shadow-sky-100 ring-2 ring-sky-200/80",
