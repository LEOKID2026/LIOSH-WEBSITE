...
export const MATH_BRIGHT = Object.freeze({
  ...
  answerWrap:
    "w-full mb-3 p-4 rounded-lg bg-sky-50 border border-sky-200 shadow-sm",
  ...
  vkKey:
    "min-h-[44px] rounded-lg border border-slate-300 bg-white text-slate-900 text-lg font-bold active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed hover:border-sky-400 hover:bg-sky-50 transition-transform",
  vkKeyCompact:
    "min-h-[40px] h-10 rounded-md border border-slate-300 bg-white text-slate-900 text-base font-semibold leading-none active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed hover:border-sky-400 hover:bg-sky-50 transition-transform",
  vkSubmitGreen:
    "col-span-3 min-h-[40px] h-10 rounded-md border border-emerald-500 bg-emerald-500 text-white text-base font-bold leading-none active:scale-[0.98] disabled:opacity-40 hover:bg-emerald-600 transition-transform",
  vkSubmitBlue:
    "col-span-3 min-h-[40px] h-10 rounded-md border border-cyan-500 bg-cyan-500 text-white text-base font-bold leading-none active:scale-[0.98] disabled:opacity-40 hover:bg-cyan-600 transition-transform",

  inputDesktop:
    "w-full px-4 py-4 rounded-lg bg-white border border-slate-300 text-slate-900 text-2xl font-bold text-center leading-none disabled:opacity-50 disabled:bg-slate-100",
  inputMobile:
    "w-full h-11 max-h-11 px-3 py-0 rounded-lg bg-white border border-slate-200 text-slate-900 text-lg font-semibold text-center leading-none placeholder:text-slate-400 disabled:opacity-50 disabled:bg-slate-100 [appearance:textfield] overflow-hidden text-ellipsis whitespace-nowrap",
