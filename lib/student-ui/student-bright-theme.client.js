...
/** Outer shell for /learning hub only (Layout) — soft sky, kid-friendly. */
...
export const STUDENT_BRIGHT = Object.freeze({
  pageWrap:
    "min-h-full bg-gradient-to-b from-[#EAF6FF] via-[#F4FAFF] to-[#F8FAFC]",
  ...
  hubBackLink:
    "inline-flex items-center justify-center rounded-xl border border-sky-200 bg-white px-4 py-2 text-sm md:text-base font-semibold text-sky-800 hover:bg-sky-50 hover:border-sky-300 transition min-h-11 shadow-sm shrink-0",
  hubTopBar:
