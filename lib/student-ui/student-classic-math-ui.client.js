...
export const MATH_CLASSIC = Object.freeze({
  ...
  adSlot:
    "w-full max-w-lg md:max-w-3xl lg:max-w-4xl xl:max-w-4xl mx-auto shrink-0 h-10 md:h-12 min-h-[2.5rem] rounded-lg border border-dashed border-white/15 bg-white/[0.03] pointer-events-none",
  btnSoundOn:
  ...
  answerWrap: "w-full mb-3 p-4 max-[420px]:p-2 max-[420px]:mb-2 rounded-lg bg-blue-500/20 border border-blue-400/50",
